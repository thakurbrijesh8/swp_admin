<tr id="migrant_contractor_workers_name_{{item_cnt}}" class="migrant_contractor_workers_name" style="background-color: #fff;">
    <td style="width: 10px;">
        <input type="hidden" class='temp_cnt' value="{{item_cnt}}"><label>Sr No.</label><br><span class="display-cnt">{{cnt}}</span>
    </td>
    <td style="width: 260px;"><label>Contractor Establishment<br> Name <span style="color: red;">*</span></label><br>
        <input type="text" id="migrant_contractor_proprietor_name_{{item_cnt}}" name="migrant_contractor_proprietor_name_" maxlength="100" class="form-control" style="margin-top: 20px;"
               onblur="checkValidation('migrantworkers', 'migrant_contractor_proprietor_name_{{item_cnt}}', contractorPropriterNameValidationMessage);" value="{{mc_proprietor_name}}" disabled>
    ...
    <td style="width: 260px;"><label>Name of<br> contractors  <span style="color: red;">*</span></label>
        <input type="text" id="migrant_contractor_name_{{item_cnt}}" name="migrant_contractor_name" class="form-control" style="margin-top: 20px;" disabled
    ...
    <td style="width: 300px;"><label>Address of <br>contractors  <span style="color: red;">*</span></label>
        <input type="text" id="migrant_contractor_address_{{item_cnt}}" name="migrant_contractor_address" class="form-control" maxlength="150" style="margin-top: 20px;" disabled
    ...
    <td style="width: 260px;"><label>Nature of work in which, migrant workman are to be recruited or are employed<span style="color: red;">*</span></label>
        <input type="text" id="migrant_contractor_nature_of_working_{{item_cnt}}" name="migrant_contractor_nature_of_working" 
               class="form-control" maxlength="200" 
               onblur="checkValidation('migrantworkers', 'migrant_contractor_nature_of_working_{{item_cnt}}', contractorNatureOfWorkingValidationMessage);" value="{{mc_nature_of_work}}" disabled>
...
<tr id="migrant_contractor_workers_name_id_{{item_cnt}}" style="background-color: #fff;">
    ...
    <td><label>Maximum No. of migrant workman to be employed on any day through each contractor <span style="color: red;">*</span></label>
        <input type="text" id="migrant_contractor_maximum_no_of_workers_{{item_cnt}}" name="migrant_contractor_maximum_no_of_workers_" class="form-control" maxlength="5" 
               onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));" disabled
    ...
    <td><label>Estimated date of commencement of work under each contractor <span style="color: red;">*</span></label>
        <div class="input-group date date_picker" style="margin-top: 20px;">
            <input type="text" name="migrant_contractor_commencement_date" id="migrant_contractor_commencement_date_{{item_cnt}}" class="form-control" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                   value="{{mc_date_of_commencement}}" disabled onblur="checkValidation('migrantworkers', 'migrant_contractor_commencement_date_{{item_cnt}}', contractorStartDateValidationMessage);">
    ...
    <td><label>Estimated date of termination of employment of migrant workman under each contractor <span style="color: red;">*</span></label>
        <div class="input-group date date_picker">
            <input type="text" name="migrant_contractor_termination_date" id="migrant_contractor_termination_date_{{item_cnt}}" class="form-control" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                   value="{{mc_date_of_termination}}" disabled
