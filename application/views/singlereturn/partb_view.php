            ...
            <form role="form" id="single_return_partb_form" name="single_return_partb_form" onsubmit="return false;">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="percentage_of_bonus" name="percentage_of_bonus" class="form-control" placeholder="Enter Percentage of bonus paid !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'percentage_of_bonus', percentageBonusValidationMessage);" value="{{percentage_of_bonus}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_baneficiaries" name="no_of_baneficiaries" class="form-control" placeholder="Enter Number of baneficiaries !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'no_of_baneficiaries', noOfBeneficiariesValidationMessage);" value="{{no_of_baneficiaries}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_bonus_paid" name="total_bonus_paid" class="form-control" placeholder="Enter Total amount of bonus paid !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'total_bonus_paid', bonusPaidValidationMessage);" value="{{total_bonus_paid}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="payment_date" id="payment_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{payment_date}}" readonly onblur="checkValidation('bocw', 'payment_date', paymentDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            <label>5. If bonus is not paid, reason there of<span class="color-nic-red">*</span></label>
                            <div class="input-group">
                                <input type="text" id="not_paid_reason" name="not_paid_reason" class="form-control" placeholder="Enter if bonus is not paid, reason there of !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'not_paid_reason', bonusReasonValidationMessage);" value="{{not_paid_reason}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partb_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewPartC($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', false);" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_parta_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewPartA($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', false);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
