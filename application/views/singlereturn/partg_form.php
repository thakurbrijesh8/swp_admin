                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_employed_workers" name="no_of_employed_workers" class="form-control" placeholder="Enter Total No. of  workers employed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_employed_workers', noOfEmployedWorkersValidationMessage);" value="{{no_of_employed_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_handicapped_employed" name="no_of_handicapped_employed" class="form-control" placeholder="Enter Number of physically handicapped persons employed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_handicapped_employed', noOfHandicappedEmployedValidationMessage);" value="{{no_of_handicapped_employed}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_surgeon_obtain_yes" name="is_surgeon_obtain" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_handicapped_recuited_yes" name="is_handicapped_recuited" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_record_physically_handicapped_yes" name="is_record_physically_handicapped" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="draft_btn_for_shop" class="btn btn-sm btn-success" onclick="SingleReturn.listview.submitPartGDetails('{{VALUE_TWO}}');"  style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
