                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_name" name="contractor_name" class="form-control" placeholder="Enter Name of the contractor !"
                                       maxlength="100" onblur="checkValidation('single-return', 'contractor_name', contractorNameValidationMessage);" value="{{contractor_name}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="contractor_address" name="contractor_address" class="form-control" placeholder="Enter Address of the contractor !"
                                       maxlength="100" onblur="checkValidation('single-return', 'contractor_address', contractorAddressValidationMessage);">{{contractor_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_nature" name="contractor_nature" class="form-control" placeholder="Enter Nature of work/operations of contractor !"
                                       maxlength="100" onblur="checkValidation('single-return', 'contractor_nature', contractorNatureValidationMessage);" value="{{contractor_nature}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_employed_labour" name="total_employed_labour" class="form-control" placeholder="Enter Total number of days during the year on which contract labour was employed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_employed_labour', employedLabourValidationMessage);" value="{{total_employed_labour}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_worked_days_by_labour" name="total_worked_days_by_labour" class="form-control" placeholder="Enter Total number of man days worked during the year by the contract labour !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_worked_days_by_labour', labourWorkedDaysValidationMessage);" value="{{total_worked_days_by_labour}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_employed_direct_labour" name="total_employed_direct_labour" class="form-control" placeholder="Enter Total number of days during the year on which direct labour was employed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_employed_direct_labour', employedDirectLabourValidationMessage);" value="{{total_employed_direct_labour}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_worked_days_by_direct_labour" name="total_worked_days_by_direct_labour" class="form-control" placeholder="Enter Total number of man days worked by direct labour !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_worked_days_by_direct_labour', directLabouWOrkedDaysValidationMessage);" value="{{total_worked_days_by_direct_labour}}">
                            </div>
                            <span class="error-message error-message-single-return-total_worked_days_by_direct_labour"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>8. Change, if any, in the management of establishments its locations or any, other particulars furnished to the registring Officer in the application for the registration (details may be furnished with dates of change)</label>
                            <div class="input-group">
                                <textarea id="change_management_details" name="change_management_details" class="form-control" placeholder="Enter Change, if any, in the management of establishments !"
                                       maxlength="100" onblur="checkValidation('single-return', 'change_management_details', changeManagementDetailsValidationMessage);">{{change_management_details}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="duration_of_contract" name="duration_of_contract" class="form-control" placeholder="Enter Duration of contract Number of days worked during the year  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'duration_of_contract', contractDurationValidationMessage);" value="{{duration_of_contract}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_contract_labour" name="no_of_contract_labour" class="form-control" placeholder="Enter Average number of contract labour worked on any day during the year  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_contract_labour', contractLanourValidationMessage);" value="{{no_of_contract_labour}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="working_hours" name="working_hours" class="form-control" placeholder="Enter Working hours  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'working_hours', workHoursValidationMessage);" value="{{working_hours}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="overtime_work" name="overtime_work" class="form-control" placeholder="Enter Overtime work  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'overtime_work', overtimeWorkDaysValidationMessage);" value="{{overtime_work}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="weekly_holiday" name="weekly_holiday" class="form-control" placeholder="Enter Weekly holiday  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'weekly_holiday', weeklyHolidayValidationMessage);" value="{{weekly_holiday}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="spread_over" name="spread_over" class="form-control" placeholder="Enter Spread over  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'spread_over', spreadOverValidationMessage);" value="{{spread_over}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_paid_weekly_holiday_yes" name="is_paid_weekly_holiday" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="male_worked_days" name="male_worked_days" class="form-control" placeholder="Enter Male  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('male_worked_days','female_worked_days','total_worked_days');checkNumeric($(this));checkValidation('single-return', 'male_worked_days', maleWOrkedDaysValidationMessage);" value="{{male_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="female_worked_days" name="female_worked_days" class="form-control" placeholder="Enter Female  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('male_worked_days','female_worked_days','total_worked_days');checkNumeric($(this));checkValidation('single-return', 'female_worked_days', femaleWOrkedDaysValidationMessage);" value="{{female_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_worked_days" name="total_worked_days" class="form-control" placeholder="Enter Total  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_worked_days', totalWOrkedDaysValidationMessage);" value="{{total_worked_days}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="paid_amount" name="paid_amount" class="form-control" placeholder="Enter Amount of wages paid !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'paid_amount', paidAmountValidationMessage);" value="{{paid_amount}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="amount_deduction" name="amount_deduction" class="form-control" placeholder="Enter Amount of deduction from wages  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'amount_deduction', amountDeductionValidationMessage);" value="{{amount_deduction}}">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_restroom_yes" name="is_provide_restroom" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_creches_yes" name="is_provide_creches" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_firstaid_yes" name="is_provide_firstaid" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partc_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.submitPartCDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_partb_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewPartB($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
