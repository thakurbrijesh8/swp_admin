                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="fin" name="fin" class="form-control" placeholder="Enter FIN (Factory Identification Number) !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'fin', finValidationMessage);" value="{{fin}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="nic_code" name="nic_code" class="form-control" placeholder="Enter NIC code !"
                                       maxlength="8" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'nic_code', nicCodeValidationMessage);" value="{{nic_code}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" style="margin-top: 22px;" 
                                    data-placeholder="Select Sector !" name="sector" id="sector" onblur="checkValidation('dealer', 'sector', sectorValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" style="margin-top: 22px;" 
                                    data-placeholder="Select Registration Under Section !" name="registration_section" id="registration_section" onblur="checkValidation('dealer', 'registration_section', registrationSectionValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_no" name="registration_no" class="form-control" placeholder="Enter Registration Number !"
                                       maxlength="100" onblur="checkValidation('single-return', 'registration_no', registrationNumberValidationMessage);" value="{{registration_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_no" name="license_no" class="form-control" placeholder="Enter License Number !"
                                       maxlength="100" onblur="checkValidation('single-return', 'license_no', licenseNumberValidationMessage);" value="{{license_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_workers" name="license_workers" class="form-control" placeholder="Enter Licensed Workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'license_workers', licenseWorkerValidationMessage);" value="{{license_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_hp" name="license_hp" class="form-control" placeholder="Enter Lisensed H.P. !"
                                       maxlength="100" onblur="checkValidation('single-return', 'license_hp', licensehpValidationMessage);" value="{{license_hp}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_renewal_year" name="license_renewal_year" class="form-control" placeholder="Enter Licensed Renewal position !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'license_renewal_year', licenseRenewalYearValidationMessage);" value="{{license_renewal_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_submitted_year" name="license_submitted_year" class="form-control" placeholder="Enter Licensed Renewal Application submitted for the year  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'license_submitted_year', licenseSubmitYearValidationMessage);" value="{{license_submitted_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="plan_approval_no" name="plan_approval_no" class="form-control" placeholder="Enter Plan Approval No. !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'plan_approval_no', planApprovalNumberValidationMessage);" value="{{plan_approval_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="plan_approval_date" id="plan_approval_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{plan_approval_date}}" onblur="checkValidation('bocw', 'plan_approval_date', planApprovalDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="certificate_obtain_on_date" id="certificate_obtain_on_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{certificate_obtain_on_date}}" onblur="checkValidation('bocw', 'certificate_obtain_on_date', certificateObtainDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="certificate_submitted_on_date" id="certificate_submitted_on_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{certificate_submitted_on_date}}" onblur="checkValidation('bocw', 'certificate_submitted_on_date', certificateSubmitDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="finished_product" name="finished_product" class="form-control" placeholder="Enter Finished Product !"
                                       maxlength="100" onblur="checkValidation('single-return', 'finished_product', finishedProductValidationMessage);">{{finished_product}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="intermediates" name="intermediates" class="form-control" placeholder="Enter Intermediates !"
                                       maxlength="100" onblur="checkValidation('single-return', 'intermediates', intermediatesValidationMessage);">{{intermediates}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="raw_materials" name="raw_materials" class="form-control" placeholder="Enter Raw materials !"
                                       maxlength="100" onblur="checkValidation('single-return', 'raw_materials', rawMaterialValidationMessage);">{{raw_materials}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="male_average_workers" name="male_average_workers" class="form-control" placeholder="Enter Male workers !"
                                       maxlength="100" onblur="checkValidation('single-return', 'male_average_workers', malAverageWorkersValidationMessage);" value="{{male_average_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="female_average_workers" name="female_average_workers" class="form-control" placeholder="Enter Female workers !"
                                       maxlength="100" onblur="checkValidation('single-return', 'female_average_workers', femalAverageWorkersValidationMessage);" value="{{female_average_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="factory_worked_days" name="factory_worked_days" class="form-control" placeholder="Enter Number of days the factory worked during previous Year !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'factory_worked_days', factoryWorkedDaysValidationMessage);" value="{{factory_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_worked_days" name="adult_men_worked_days" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_worked_days','adult_women_worked_days','adult_total_worked_days');checkNumeric($(this));checkValidation('single-return', 'adult_men_worked_days', adultMenValidationMessage);" value="{{adult_men_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_worked_days" name="adult_women_worked_days" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_worked_days','adult_women_worked_days','adult_total_worked_days');checkNumeric($(this));checkValidation('single-return', 'adult_women_worked_days', adultWomenValidationMessage);" value="{{adult_women_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_worked_days" name="adult_total_worked_days" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_worked_days', adultTotalValidationMessage);" value="{{adult_total_worked_days}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_worked_days" name="adolescent_men_worked_days" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_worked_days','adolescent_women_worked_days','adolescent_total_worked_days');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_worked_days', adolescentMenValidationMessage);" value="{{adolescent_men_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_worked_days" name="adolescent_women_worked_days" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_worked_days','adolescent_women_worked_days','adolescent_total_worked_days');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_worked_days', adolescentWomenValidationMessage);" value="{{adolescent_women_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_worked_days" name="adolescent_total_worked_days" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_worked_days', adolescentOtherValidationMessage);" value="{{adolescent_total_worked_days}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_workers_employed" name="adult_men_workers_employed" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_workers_employed','adult_women_workers_employed','adult_total_workers_employed');checkNumeric($(this));checkValidation('single-return', 'adult_men_workers_employed', adultMenValidationMessage);" value="{{adult_men_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_workers_employed" name="adult_women_workers_employed" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_workers_employed','adult_women_workers_employed','adult_total_workers_employed');checkNumeric($(this));checkValidation('single-return', 'adult_women_workers_employed', adultWomenValidationMessage);" value="{{adult_women_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_workers_employed" name="adult_total_workers_employed" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_workers_employed', adultTotalValidationMessage);" value="{{adult_total_workers_employed}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_workers_employed" name="adolescent_men_workers_employed" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_workers_employed','adolescent_women_workers_employed','adolescent_total_workers_employed');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_workers_employed', adolescentMenValidationMessage);" value="{{adolescent_men_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_workers_employed" name="adolescent_women_workers_employed" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_workers_employed','adolescent_women_workers_employed','adolescent_total_workers_employed');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_workers_employed', adolescentWomenValidationMessage);" value="{{adolescent_women_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_workers_employed" name="adolescent_total_workers_employed" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_workers_employed', adolescentOtherValidationMessage);" value="{{adolescent_total_workers_employed}}" readonly>
                            </div>
                            <span class="error-message error-message-single-return-adolescent_total_workers_employed" readonly></span>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_work_hours" name="adult_men_work_hours" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_work_hours','adult_women_work_hours','adult_total_work_hours');checkNumeric($(this));checkValidation('single-return', 'adult_men_work_hours', adultMenValidationMessage);" value="{{adult_men_work_hours}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_work_hours" name="adult_women_work_hours" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_work_hours','adult_women_work_hours','adult_total_work_hours');checkNumeric($(this));checkValidation('single-return', 'adult_women_work_hours', adultWomenValidationMessage);" value="{{adult_women_work_hours}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_work_hours" name="adult_total_work_hours" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_work_hours', adultTotalValidationMessage);" value="{{adult_total_work_hours}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_work_hours" name="adolescent_men_work_hours" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_work_hours','adolescent_women_work_hours','adolescent_total_work_hours');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_work_hours', adolescentMenValidationMessage);" value="{{adolescent_men_work_hours}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_work_hours" name="adolescent_women_work_hours" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_work_hours','adolescent_women_work_hours','adolescent_total_work_hours');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_work_hours', adolescentWomenValidationMessage);" value="{{adolescent_women_work_hours}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_work_hours" name="adolescent_total_work_hours" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_work_hours', adolescentOtherValidationMessage);" value="{{adolescent_total_work_hours}}" readonly>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="box-footer" align="right" >
                                <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_dangerous_process" onclick="SingleReturn.listview.addDangerousProcess({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Dangerous Process
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="box-footer" align="right" >
                                <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_hazardous_process" onclick="SingleReturn.listview.addHazardousProcess({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Hazardous Process
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_dust_generated_yes" name="is_dust_generated" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_drinking_water_yes" name="is_provide_drinking_water" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_washroom_yes" name="is_provide_washroom" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-3 is_provide_washroom_div" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="text" id="washroom_for_men" name="washroom_for_men" class="form-control" placeholder="Enter Number of Urinals,Latrines & Bathroom !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'washroom_for_men', noOfWashroomValidationMessage);" value="{{washroom_for_men}}">
                            </div>
                        ...
                        <div class="form-group col-sm-3 is_provide_washroom_div" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="text" id="washroom_for_women" name="washroom_for_women" class="form-control" placeholder="Enter Number of Urinals,Latrines & Bathroom !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'washroom_for_women', noOfWashroomValidationMessage);" value="{{washroom_for_women}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_health_record_maintain_yes" name="is_health_record_maintain" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_health_center_yes" name="is_provide_health_center" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_medical_officer_yes" name="is_provide_medical_officer" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6 is_provide_medical_officer_div" style="display: none">
                            ...
                            <div class="input-group">
                                <select class="form-control"  
                                    data-placeholder="Select Retainer Ship !" name="retainer_ship" id="retainer_ship" onblur="checkValidation('dealer', 'retainer_ship', retainerShipValidationValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_hyginists_employed" name="no_of_hyginists_employed" class="form-control" placeholder="Enter Number of industrial Hygienists employed to monitor work !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_hyginists_employed', hyginistsEmployedValidationMessage);" value="{{no_of_hyginists_employed}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <textarea id="safety_provision" name="safety_provision" class="form-control" placeholder="Enter Compliance of safety provisions prescribed under Schedules !"
                                       maxlength="100" onblur="checkValidation('single-return', 'safety_provision', safetyProvisionValidationMessage);" >{{safety_provision}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_safe_access_yes" name="is_provide_safe_access" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_fire_exits_yes" name="is_provide_fire_exits" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="fighting_equipments_details" name="fighting_equipments_details" class="form-control" placeholder="Enter Details of fire fighting equipments including water storage capacity & trained personal!"
                                       maxlength="100" onblur="checkValidation('single-return', 'fighting_equipments_details', fightingEuipmentsValidationMessage);">{{fighting_equipments_details}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_devices_certified_yes" name="is_devices_certified" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_pressure_vessels_certified_yes" name="is_pressure_vessels_certified" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>4.7 Details of personal protective equipments provided and special safety equipments if any(Sec.41)</label>
                            <div class="input-group">
                                <textarea id="personal_equipments_details" name="personal_equipments_details" class="form-control" placeholder="Enter Details of personal protective equipments provided and special safety equipments!"
                                       maxlength="100" onblur="checkValidation('single-return', 'personal_equipments_details', personalequipmentsValidationMessage);">{{personal_equipments_details}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="safety_officers_detail" name="safety_officers_detail" class="form-control" placeholder="Enter Details of Safety Officers & Safety Supervisors!"
                                       maxlength="100" onblur="checkValidation('single-return', 'safety_officers_detail', safetyOfficerValidationMessage);">{{safety_officers_detail}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>4.9 Safety Committee functioning ? (if applicable)</label>
                            <div class="input-group">
                                <input type="radio" id="is_functioning_safety_committee_yes" name="is_functioning_safety_committee" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provision_of_chapteriva_yes" name="is_provision_of_chapteriva" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_safety_programs" name="no_of_safety_programs" class="form-control" placeholder="Enter Number of Safety programs for training & safety awareness arranged during last year !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_safety_programs', safetyProgramsValidationMessage);" value="{{no_of_safety_programs}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_worker_trained" name="no_of_worker_trained" class="form-control" placeholder="Enter number of workers trained through it !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_worker_trained', workerTrainedValidationMessage);" value="{{no_of_worker_trained}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="amended_date" id="amended_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{amended_date}}" onblur="checkValidation('bocw', 'amended_date', amendedDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="rehearsals_date" id="rehearsals_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{rehearsals_date}}" onblur="checkValidation('bocw', 'rehearsals_date', rehearsalsDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>4.13.3 Details of Safety Policy, Safety Audit & Safety Report. (if applicable)</label>
                            <div class="input-group">
                                <textarea id="safety_policy_detail" name="safety_policy_detail" class="form-control" placeholder="Enter Details of fire fighting equipments including water storage capacity & trained personal!"
                                       maxlength="100" onblur="checkValidation('single-return', 'safety_policy_detail', safetyPolicyValidationMessage);">{{safety_policy_detail}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_action_taken_yes" name="is_action_taken" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_firstaid_provide_yes" name="is_firstaid_provide" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            <label>5.2 Provision of Ambulance Room, required staff, Ambulance Van (if applicable) (Sec.45)</label>
                            <div class="input-group">
                                <input type="radio" id="is_ambulance_room_provide_yes" name="is_ambulance_room_provide" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_canteen_yes" name="is_provide_canteen" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" style="margin-top: 22px;" 
                                    data-placeholder="Select canteen managed !" name="canteen_managed_by" id="canteen_managed_by" onblur="checkValidation('dealer', 'canteen_managed_by', cateenManagedByValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_rest_room_yes" name="is_provide_rest_room" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_provide_creche_yes" name="is_provide_creche" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_welfare_officer_apponyed_yes" name="is_welfare_officer_apponyed" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="working_hours_for_adults" name="working_hours_for_adults" class="form-control" placeholder="Enter Compliance of provisions relating to working hours for adults !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'working_hours_for_adults', workingHoursValidationMessage);" value="{{working_hours_for_adults}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_disply_period_of_work_yes" name="is_disply_period_of_work" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="working_hours_for_women" name="working_hours_for_women" class="form-control" placeholder="Enter Normal working time for women !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'working_hours_for_women', workingHoursValidationMessage);" value="{{working_hours_for_women}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_obtain_fitness_certificate_yes" name="is_obtain_fitness_certificate" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_leave_with_wages_yes" name="is_leave_with_wages" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_worker_dismissed" name="no_of_worker_dismissed" class="form-control" placeholder="Enter Total number of workers discharged / dismissed from the service !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_worker_dismissed', workerDismissedValidationMessage);" value="{{no_of_worker_dismissed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_paid_leave_worker" name="no_of_paid_leave_worker" class="form-control" placeholder="Enter Number of workers in respect of whom wages !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_paid_leave_worker', paidLeaveWorkerValidationMessage);" value="{{no_of_paid_leave_worker}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_workers_employed_year" name="adult_men_workers_employed_year" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_workers_employed_year','adult_women_workers_employed_year','adult_total_workers_employed_year');checkNumeric($(this));checkValidation('single-return', 'adult_men_workers_employed_year', adultMenValidationMessage);" value="{{adult_men_workers_employed_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_workers_employed_year" name="adult_women_workers_employed_year" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_workers_employed_year','adult_women_workers_employed_year','adult_total_workers_employed_year');checkNumeric($(this));checkValidation('single-return', 'adult_women_workers_employed_year', adultWomenValidationMessage);" value="{{adult_women_workers_employed_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_workers_employed_year" name="adult_total_workers_employed_year" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_workers_employed_year', adultTotalValidationMessage);" value="{{adult_total_workers_employed_year}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_workers_employed_year" name="adolescent_men_workers_employed_year" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_workers_employed_year','adolescent_women_workers_employed_year','adolescent_total_workers_employed_year');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_workers_employed_year', adolescentMenValidationMessage);" value="{{adolescent_men_workers_employed_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_workers_employed_year" name="adolescent_women_workers_employed_year" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_workers_employed_year','adolescent_women_workers_employed_year','adolescent_total_workers_employed_year');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_workers_employed_year', adolescentWomenValidationMessage);" value="{{adolescent_women_workers_employed_year}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_workers_employed_year" name="adolescent_total_workers_employed_year" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_workers_employed_year', adolescentOtherValidationMessage);" value="{{adolescent_total_workers_employed_year}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_leave_with_wages" name="adult_men_leave_with_wages" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_leave_with_wages','adult_women_leave_with_wages','adult_total_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adult_men_leave_with_wages', adultMenValidationMessage);" value="{{adult_men_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_leave_with_wages" name="adult_women_leave_with_wages" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_leave_with_wages','adult_women_leave_with_wages','adult_total_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adult_women_leave_with_wages', adultWomenValidationMessage);" value="{{adult_women_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_leave_with_wages" name="adult_total_leave_with_wages" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_leave_with_wages', adultTotalValidationMessage);" value="{{adult_total_leave_with_wages}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_leave_with_wages" name="adolescent_men_leave_with_wages" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_leave_with_wages','adolescent_women_leave_with_wages','adolescent_total_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_leave_with_wages', adolescentMenValidationMessage);" value="{{adolescent_men_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_leave_with_wages" name="adolescent_women_leave_with_wages" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_leave_with_wages','adolescent_women_leave_with_wages','adolescent_total_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_leave_with_wages', adolescentWomenValidationMessage);" value="{{adolescent_women_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_leave_with_wages" name="adolescent_total_leave_with_wages" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_leave_with_wages', adolescentOtherValidationMessage);" value="{{adolescent_total_leave_with_wages}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_men_annual_leave_with_wages" name="adult_men_annual_leave_with_wages" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_annual_leave_with_wages','adult_women_annual_leave_with_wages','adult_total_annual_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adult_men_annual_leave_with_wages', adultMenValidationMessage);" value="{{adult_men_annual_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_women_annual_leave_with_wages" name="adult_women_annual_leave_with_wages" class="form-control" placeholder="Enter Women workers !" 
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adult_men_annual_leave_with_wages','adult_women_annual_leave_with_wages','adult_total_annual_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adult_women_annual_leave_with_wages', adultWomenValidationMessage);" value="{{adult_women_annual_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_total_annual_leave_with_wages" name="adult_total_annual_leave_with_wages" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adult_total_annual_leave_with_wages', adultTotalValidationMessage);" value="{{adult_total_annual_leave_with_wages}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_men_annual_leave_with_wages" name="adolescent_men_annual_leave_with_wages" class="form-control" placeholder="Enter Men workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_annual_leave_with_wages','adolescent_women_annual_leave_with_wages','adolescent_total_annual_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adolescent_men_annual_leave_with_wages', adolescentMenValidationMessage);" value="{{adolescent_men_annual_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_women_annual_leave_with_wages" name="adolescent_women_annual_leave_with_wages" class="form-control" placeholder="Enter Women workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="getTotalWorker('adolescent_men_annual_leave_with_wages','adolescent_women_annual_leave_with_wages','adolescent_total_annual_leave_with_wages');checkNumeric($(this));checkValidation('single-return', 'adolescent_women_annual_leave_with_wages', adolescentWomenValidationMessage);" value="{{adolescent_women_annual_leave_with_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="adolescent_total_annual_leave_with_wages" name="adolescent_total_annual_leave_with_wages" class="form-control" placeholder="Enter Total workers !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'adolescent_total_annual_leave_with_wages', adolescentOtherValidationMessage);" value="{{adolescent_total_annual_leave_with_wages}}" readonly>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_report_accident_yes" name="is_report_accident" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th><input type="text" id="nonfatal_dangerous_major_accidents" name="nonfatal_dangerous_major_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_major_accidents', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_major_accidents}}"></th>
                                        <th><input type="text" id="nonfatal_dangerous_major_accidents_inside" name="nonfatal_dangerous_major_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_major_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_major_accidents_inside}}"></th>
                                        <th><input type="text" id="nonfatal_dangerous_major_accidents_outside" name="nonfatal_dangerous_major_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_major_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_major_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_major_accidents" name="fatal_dangerous_major_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_major_accidents', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_major_accidents}}"></th>
                                        <th><input type="text" id="fatal_dangerous_major_accidents_inside" name="fatal_dangerous_major_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_major_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_major_accidents_inside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_major_accidents_outside" name="fatal_dangerous_major_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_major_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_major_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_major_accidents_killed_inside" name="fatal_dangerous_major_accidents_killed_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_major_accidents_killed_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_major_accidents_killed_inside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_major_accidents_killed_outside" name="fatal_dangerous_major_accidents_killed_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_major_accidents_killed_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_major_accidents_killed_outside}}"></th>
                                    </tr>
                                    <tr style='color: #000;'>
                                        <th>2. Dangerous occurrences not involving injuries /deaths. </th>
                                        <th><input type="text" id="nonfatal_nondangerous_accidents" name="nonfatal_nondangerous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nondangerous_accidents', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nondangerous_accidents}}"></th>
                                        <th><input type="text" id="nonfatal_nondangerous_accidents_inside" name="nonfatal_nondangerous_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nondangerous_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nondangerous_accidents_inside}}"></th>
                                        <th><input type="text" id="nonfatal_nondangerous_accidents_outside" name="nonfatal_nondangerous_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nondangerous_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nondangerous_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_nondangerous_accidents" name="fatal_nondangerous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nondangerous_accidents', accidentsOccurrencesValidationMessage);" value="{{fatal_nondangerous_accidents}}"></th>
                                        <th><input type="text" id="fatal_nondangerous_accidents_inside" name="fatal_nondangerous_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nondangerous_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_nondangerous_accidents_inside}}"></th>
                                        <th><input type="text" id="fatal_nondangerous_accidents_outside" name="fatal_nondangerous_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nondangerous_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_nondangerous_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_nondangerous_accidents_killed_inside" name="fatal_nondangerous_accidents_killed_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nondangerous_accidents_killed_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_nondangerous_accidents_killed_inside}}"></th>
                                        <th><input type="text" id="fatal_nondangerous_accidents_killed_outside" name="fatal_nondangerous_accidents_killed_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nondangerous_accidents_killed_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_nondangerous_accidents_killed_outside}}"></th>
                                    </tr>
                                    <tr style='color: #000;'>
                                        <th>3. Dangerous occurrences involving injuries/deaths.</th>
                                        <th><input type="text" id="nonfatal_dangerous_accidents" name="nonfatal_dangerous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_accidents', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_accidents}}"></th>
                                        <th><input type="text" id="nonfatal_dangerous_accidents_inside" name="nonfatal_dangerous_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_accidents_inside}}"></th>
                                        <th><input type="text" id="nonfatal_dangerous_accidents_outside" name="nonfatal_dangerous_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_dangerous_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_dangerous_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_accidents" name="fatal_dangerous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_accidents', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_accidents}}"></th>
                                        <th><input type="text" id="fatal_dangerous_accidents_inside" name="fatal_dangerous_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_accidents_inside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_accidents_outside" name="fatal_dangerous_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_accidents_killed_inside" name="fatal_dangerous_accidents_killed_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_accidents_killed_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_accidents_killed_inside}}"></th>
                                        <th><input type="text" id="fatal_dangerous_accidents_killed_outside" name="fatal_dangerous_accidents_killed_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_dangerous_accidents_killed_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_dangerous_accidents_killed_outside}}"></th>
                                    </tr>
                                    <tr style='color: #000;'>
                                        <th>4. Major accidents involving injuries/deaths.</th>
                                        <th><input type="text" id="nonfatal_major_accidents" name="nonfatal_major_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_major_accidents', accidentsOccurrencesValidationMessage);" value="{{nonfatal_major_accidents}}"></th>
                                        <th><input type="text" id="nonfatal_major_accidents_inside" name="nonfatal_major_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_major_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_major_accidents_inside}}"></th>
                                        <th><input type="text" id="nonfatal_major_accidents_outside" name="nonfatal_major_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_major_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_major_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_major_accidents" name="fatal_major_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_major_accidents', accidentsOccurrencesValidationMessage);" value="{{fatal_major_accidents}}"></th>
                                        <th><input type="text" id="fatal_major_accidents_inside" name="fatal_major_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_major_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_major_accidents_inside}}"></th>
                                        <th><input type="text" id="fatal_major_accidents_outside" name="fatal_major_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_major_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_major_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_major_accidents_killed_inside" name="fatal_major_accidents_killed_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_major_accidents_killed_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_major_accidents_killed_inside}}"></th>
                                        <th><input type="text" id="fatal_major_accidents_killed_outside" name="fatal_major_accidents_killed_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_major_accidents_killed_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_major_accidents_killed_outside}}"></th>
                                    </tr>
                                    <tr style='color: #000;'>
                                        <th>5. Major accidents not involving injuries/deaths.</th>
                                        <th><input type="text" id="nonfatal_nonmajor_accidents" name="nonfatal_nonmajor_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nonmajor_accidents', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nonmajor_accidents}}"></th>
                                        <th><input type="text" id="nonfatal_nonmajor_accidents_inside" name="nonfatal_nonmajor_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nonmajor_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nonmajor_accidents_inside}}"></th>
                                        <th><input type="text" id="nonfatal_nonmajor_accidents_outside" name="nonfatal_nonmajor_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'nonfatal_nonmajor_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{nonfatal_nonmajor_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_nonmajor_accidents" name="fatal_nonmajor_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nonmajor_accidents', accidentsOccurrencesValidationMessage);" value="{{fatal_nonmajor_accidents}}"></th>
                                        <th><input type="text" id="fatal_nonmajor_accidents_inside" name="fatal_nonmajor_accidents_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nonmajor_accidents_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_nonmajor_accidents_inside}}"></th>
                                        <th><input type="text" id="fatal_nonmajor_accidents_outside" name="fatal_nonmajor_accidents_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nonmajor_accidents_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_nonmajor_accidents_outside}}"></th>
                                        <th><input type="text" id="fatal_nonmajor_accidents_killed_inside" name="fatal_nonmajor_accidents_killed_inside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nonmajor_accidents_killed_inside', accidentsOccurrencesValidationMessage);" value="{{fatal_nonmajor_accidents_killed_inside}}"></th>
                                        <th><input type="text" id="fatal_nonmajor_accidents_killed_outside" name="fatal_nonmajor_accidents_killed_outside" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'fatal_nonmajor_accidents_killed_outside', accidentsOccurrencesValidationMessage);" value="{{fatal_nonmajor_accidents_killed_outside}}"></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                        ...
                        <div class="form-group col-sm-12">
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        <th><input type="text" id="hazardous_accidents" name="hazardous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'hazardous_accidents', injuriesOccurringValidationMessage);" value="{{hazardous_accidents}}"></th>
                                        <th><input type="text" id="hazardous_fatal_injured" name="hazardous_fatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'hazardous_fatal_injured', injuriesOccurringValidationMessage);" value="{{hazardous_fatal_injured}}"></th>
                                        <th><input type="text" id="hazardous_nonfatal_injured" name="hazardous_nonfatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'hazardous_nonfatal_injured', injuriesOccurringValidationMessage);" value="{{hazardous_nonfatal_injured}}"></th>
                                        <th><input type="text" id="dangerous_accidents" name="dangerous_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'dangerous_accidents', injuriesOccurringValidationMessage);" value="{{dangerous_accidents}}"></th>
                                        <th><input type="text" id="dangerous_fatal_injured" name="dangerous_fatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'dangerous_fatal_injured', injuriesOccurringValidationMessage);" value="{{dangerous_fatal_injured}}"></th>
                                        <th><input type="text" id="dangerous_nonfatal_injured" name="dangerous_nonfatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'dangerous_nonfatal_injured', injuriesOccurringValidationMessage);" value="{{dangerous_nonfatal_injured}}"></th>
                                         <th><input type="text" id="other_accidents" name="other_accidents" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'other_accidents', injuriesOccurringValidationMessage);" value="{{other_accidents}}"></th>
                                        <th><input type="text" id="other_fatal_injured" name="other_fatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'other_fatal_injured', injuriesOccurringValidationMessage);" value="{{other_fatal_injured}}"></th>
                                        <th><input type="text" id="other_nonfatal_injured" name="other_nonfatal_injured" class="form-control"placeholder="" maxlength="100" onblur="checkValidation('single-return', 'other_nonfatal_injured', injuriesOccurringValidationMessage);" value="{{other_nonfatal_injured}}"></th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_non_fatal_injuries" name="no_of_non_fatal_injuries" class="form-control" placeholder="Enter Number of injuries !"
                                       maxlength="100" onblur="checkValidation('single-return', 'no_of_non_fatal_injuries', fatalinjuriesValidationMessage);" value="{{no_of_non_fatal_injuries}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_non_fatal_lost_injuries" name="no_of_non_fatal_lost_injuries" class="form-control" placeholder="Enter Mandays lost due to injuries !"
                                       maxlength="100" onblur="checkValidation('single-return', 'no_of_non_fatal_lost_injuries', nonFatalinjuriesValidationMessage);" value="{{no_of_non_fatal_lost_injuries}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_return_non_fatal_injuries" name="no_of_return_non_fatal_injuries" class="form-control" placeholder="Enter Number of injuries !"
                                       maxlength="100" onblur="checkValidation('single-return', 'no_of_return_non_fatal_injuries', returnNonFatalinjuriesValidationMessage);" value="{{no_of_return_non_fatal_injuries}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_return_non_fatal_lost_injuries" name="no_of_return_non_fatal_lost_injuries" class="form-control" placeholder="Enter Mandays lost due to injuries !"
                                       maxlength="100" onblur="checkValidation('single-return', 'no_of_return_non_fatal_lost_injuries', returnNonFatalLostinjuriesValidationMessage);" value="{{no_of_return_non_fatal_lost_injuries}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partd_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.submitPartDDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_partc_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewPartC($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
