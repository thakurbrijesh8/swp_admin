<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{singlereturn_id}}" onclick="SingleReturn.listview.editOrViewSingleReturn($(this),'{{singlereturn_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{singlereturn_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_THIRTYNINE,'{{singlereturn_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
