                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="respect_of_fines" name="respect_of_fines" class="form-control" placeholder="Enter Whether applicantion in respect of Fines being Imposed on the employees in sent !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'respect_of_fines', respectOfFinesValidationMessage);" value="{{respect_of_fines}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_worked_days" name="adult_worked_days" class="form-control" placeholder="Enter Number of man days worked !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'adult_worked_days', adultsWorkedDaysValidationMessage);" value="{{adult_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="young_person_worked_days" name="young_person_worked_days" class="form-control" placeholder="Enter Number of man days worked !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'young_person_worked_days', youngPersonWorkedDaysValidationMessage);" value="{{young_person_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="adult_workers_employed" name="adult_workers_employed" class="form-control" placeholder="Enter Average number of workers employed daily !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'adult_workers_employed', adultsWorkersEmployedValidationMessage);" value="{{adult_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="young_peson_workers_employed" name="young_peson_workers_employed" class="form-control" placeholder="Enter Average number of workers employed daily !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'young_peson_workers_employed', youngPersonWorkersEmployedValidationMessage);" value="{{young_peson_workers_employed}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="basic_wages" name="basic_wages" class="form-control" placeholder="Enter Basic wages only !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'basic_wages', basicwagesValidationMessage);" value="{{basic_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="dearness_allowances" name="dearness_allowances" class="form-control" placeholder="Enter Dearness Allowances !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'dearness_allowances', dearnessAllowancesValidationMessage);">{{dearness_allowances}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="composite_wages" name="composite_wages" class="form-control" placeholder="Enter Composite wages only !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'composite_wages', compositewagesValidationMessage);" value="{{composite_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="overtime_wages" name="overtime_wages" class="form-control" placeholder="Enter Overtime Wages !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'overtime_wages', overtimeWagesValidationMessage);">{{overtime_wages}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="nonprofit_bonus" name="nonprofit_bonus" class="form-control" placeholder="Enter Non-profit sharing bonus !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'nonprofit_bonus', nonProfitBonusValidationMessage);" value="{{nonprofit_bonus}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="other_bonus" name="other_bonus" class="form-control" placeholder="Enter Any Other Bonus !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'other_bonus', otherBonusValidationMessage);">{{other_bonus}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="other_amount" name="other_amount" class="form-control" placeholder="Enter Any other amount paid in cash which may form part of wages as define under the Act !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'other_amount', otherAmountValidationMessage);" value="{{other_amount}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="arrears_of_pat" name="arrears_of_pat" class="form-control" placeholder="Enter Arrears of pat in respects of Previous year during the year !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'arrears_of_pat', arrearsOfPatValidationMessage);">{{arrears_of_pat}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_wages" name="total_wages" class="form-control" placeholder="Enter Total wages paid !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'total_wages', totalWagesValidationMessage);" value="{{total_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="year_total_wages" name="year_total_wages" class="form-control" placeholder="Enter Total wages paid during the year !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'year_total_wages', yearTotalWagesValidationMessage);" value="{{year_total_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="year_paid_bonus" name="year_paid_bonus" class="form-control" placeholder="Enter Bonus paid during the year !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'year_paid_bonus', yearPaidBonusValidationMessage);">{{year_paid_bonus}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="commision_amount" name="commision_amount" class="form-control" placeholder="Enter Amount of money Value of Commision given during the year !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'commision_amount', commisionAmountValidationMessage);" value="{{commision_amount}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="realized_amount" name="realized_amount" class="form-control" placeholder="Enter Deduction number of case and amount realized !"
                                       maxlength="100" readonly onblur="checkValidation('single-return', 'realized_amount', realizedAmountValidationMessage);">{{realized_amount}}</textarea>
                            </div>
