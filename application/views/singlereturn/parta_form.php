        ...
        <div class="card">
            ...
            <form role="form" id="single_return_parta_form" name="single_return_parta_form" onsubmit="return false;">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="worked_days" name="worked_days" class="form-control" placeholder="Enter Number of days the esytablishment/factory worked in this year !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'worked_days', workedDaysValidationMessage);" value="{{worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="man_worked_days" name="man_worked_days" class="form-control" placeholder="Enter The number of man days worked in the year !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'man_worked_days', manWorkedDaysValidationMessage);" value="{{man_worked_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="average_emp" name="average_emp" class="form-control" placeholder="Enter The Number of Average employees employed in the year !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'average_emp', averageEmpValidationMessage);" value="{{average_emp}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="male_wages" name="male_wages" class="form-control" placeholder="Enter Total wages paid to Male !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'male_wages', maleWagesValidationMessage);" value="{{male_wages}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="female_wages" name="female_wages" class="form-control" placeholder="Enter Total wages paid to Female !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'female_wages', femaleWagesValidationMessage);" value="{{female_wages}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>6. Total Fine Imposed; If any</label>
                            <div class="input-group">
                                <input type="text" id="total_fine" name="total_fine" class="form-control" placeholder="Enter Total Fine Imposed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'total_fine', totalFineValidationMessage);" value="{{total_fine}}">
                            </div>
                            <span class="error-message error-message-single-return-total_fine"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>7. Other Deduction; If any</label>
                            <div class="input-group">
                                <input type="text" id="deduction" name="deduction" class="form-control" placeholder="Enter Other Deduction !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'deduction', deductionValidationMessage);" value="{{deduction}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_parta_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.submitPartADetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_single_return_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewSingleReturn($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
