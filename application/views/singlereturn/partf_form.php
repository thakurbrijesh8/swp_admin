                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_female_workers" name="no_of_female_workers" class="form-control" placeholder="Enter Number of female workers employed on any day !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_female_workers', noOfFemaleWorkersValidationMessage);" value="{{no_of_female_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_maternity_women_workers" name="no_of_maternity_women_workers" class="form-control" placeholder="Enter Number of women workers, claimed Maternity benefits/ No, paid !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'no_of_maternity_women_workers', noOfMaternityWomenWorkersValidationMessage);" value="{{no_of_maternity_women_workers}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="medical_bonus_case" name="medical_bonus_case" class="form-control" placeholder="Enter No. of case in which medical Bonus is claimed /paid !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'medical_bonus_case', medicalBonusValidationMessage);" value="{{medical_bonus_case}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="miscarriage_leave_case" name="miscarriage_leave_case" class="form-control" placeholder="Enter No. of case of leave for miscarriage is applied/granted !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'miscarriage_leave_case', miscarriageLeaveValidationMessage);" value="{{miscarriage_leave_case}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="additional_leave_case" name="additional_leave_case" class="form-control" placeholder="Enter Number of cases of additional leave for illness applied/granted !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'additional_leave_case', additionalLeaveValidationMessage);" value="{{additional_leave_case}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="maternity_benefit_amount" name="maternity_benefit_amount" class="form-control" placeholder="Enter Total Amount of Maternity Benefit paid !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'maternity_benefit_amount', maternityBenefitAmountValidationMessage);" value="{{maternity_benefit_amount}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="is_nursing_breaks_yes" name="is_nursing_breaks" class="" value="{{VALUE_ONE}}">&nbsp; Yes
                                &emsp;
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="checkbox" id="is_dismissed_service" name="is_dismissed_service" class="checkbox" value="{{is_checked}}">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_dismissed_women" name="no_of_dismissed_women" class="form-control" placeholder="Enter Number of women dismissed !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('factory-license', 'no_of_dismissed_women', dismissedWomenValidationMessage);" value="{{no_of_dismissed_women}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="dismissed_reason" name="dismissed_reason" class="form-control" placeholder="Enter Reason thereof !"
                                       maxlength="100" onblur="checkValidation('single-return', 'dismissed_reason', dismissedReasonValidationMessage);">{{dismissed_reason}}</textarea>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partf_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.submitPartFDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_parte_details" class="btn btn-sm btn-success pull-right" onclick="SingleReturn.listview.editOrViewPartE($('#previous_btn_for_parta_details'), '{{singlereturn_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
