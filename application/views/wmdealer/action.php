<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{dealer_id}}" onclick="Dealer.listview.editOrViewDealer($(this),'{{dealer_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{dealer_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_THREE,'{{dealer_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
