<html>
    ...
    <body>
        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['name_of_dealer']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['complete_address']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo convert_to_new_date_format($dealer_data['establishment_date']); ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php 
                        if($dealer_data['proprietor_details']){ ?>
                        <table class="newTable" border="1">
                            ...
                            <?php
                                $proprietorinfo = json_decode($dealer_data['proprietor_details'], TRUE);
                                $i=1;
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['registration_number']; ?><br/>
                    <?php echo convert_to_new_date_format($dealer_data['registration_date']); ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['categories_sold']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php 
                        if($dealer_data['identity_choice'] == 1)
                            echo 'VAT Registration Number'; 
                        else if($dealer_data['identity_choice'] == 2)
                            echo 'Sales Tax Registration Number'; 
                        else if($dealer_data['identity_choice'] == 3)
                            echo 'CST Number'; 
                        else if($dealer_data['identity_choice'] == 4)
                            echo 'Professional Tax Registration Number'; 
                        else if($dealer_data['identity_choice'] == 5)
                            echo 'IT Number'; 
                    ?><br/>
                    <?php echo $dealer_data['identity_number']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['import_from_outside'] == 1 ? 'YES' : 'NO'; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $dealer_data['registration_of_importer']; ?>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;"></td>
                <td class="second-column">(b)Approval of model imported into India by Central Government:</td>
                <td class="third-column"><a href ="<?php echo DEALER_DOC_PATH; ?><?php echo $dealer_data['import_model']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;">9</td>
                <td class="second-column">Have you applied previously for a dealer's’s license ?:<br/>If so, When and with What Result :</td>
                <td class="third-column">
                    <?php echo $dealer_data['any_previous_application'] == 1 ? 'YES' : 'NO'; ?><br/>
                    <?php echo $dealer_data['license_application_date']; ?><br/>
                    <?php echo $dealer_data['license_application_result']; ?>
                </td>
            </tr>
        </table>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo DEALER_DOC_PATH; ?><?php echo $dealer_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>
