            ...
            <form role="form" id="bocw_form" name="bocw_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_bocw" class="btn btn-sm btn-success" onclick="BOCW.listview.submitBOCW({{VALUE_TWO}});" style="margin-right: 5px;">Submit</button>
