    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="bocw_form" name="bocw_form" onsubmit="return false;">
                <input type="hidden" name="temp_sign_of_principal_employee" id="temp_sign_of_principal_employee" class="form-control" value="{{bocw_data.sign_of_principal_employee}}">
                <input type="hidden" id="bocw_id" name="bocw_id" value="{{bocw_data.bocw_id}}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <span class="error-message error-message-bocw f-w-b" style="border-bottom: 2px solid red;"></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                    data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('bocw', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                            </select>
                            </div>
                            <span class="error-message error-message-bocw-entity_establishment_type"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="postal_address_of_est" name="postal_address_of_est" class="form-control" placeholder="Enter Postal address of the Establishment !" maxlength="100" onblur="checkValidation('bocw', 'postal_address_of_est', postalAddressValidationMessage);" style="margin-top: 20px;">{{bocw_data.postal_address_of_est}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="name_address_of_est" name="name_address_of_est" class="form-control" placeholder="Enter Full name and permanent address of the Establishment,if any !" maxlength="100" style="margin-top: 22px;">{{bocw_data.name_address_of_est}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="name_address_of_manager" name="name_address_of_manager" class="form-control" placeholder="Enter Full name and address of the Manager or persons responsible for the supervision and control of the Establishment !" maxlength="100" onblur="checkValidation('bocw', 'name_address_of_manager', managerNameAddressValidationMessage);">{{bocw_data.name_address_of_manager}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="nature_of_building" name="nature_of_building" class="form-control" placeholder="Nature of building or other construction work carried is to be carried on in the Establishment !"
                                   maxlength="100" onblur="checkValidation('bocw', 'nature_of_building', buildingNatureValidationMessage);" value="{{bocw_data.nature_of_building}}">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="max_num_building_workers" name="max_num_building_workers" class="form-control" placeholder="Maximum number of building workers to be employed on any day !"
                                   maxlength="25" onkeyup="checkNumeric($(this));" onblur="checkValidation('bocw', 'max_num_building_workers', maxnumberValidationMessage);" value="{{bocw_data.max_num_building_workers}}" style="margin-top: 20px;">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="estimated_date_of_commencement" id="estimated_date_of_commencement" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{estimated_date_of_commencement}}" onblur="checkValidation('bocw', 'estimated_date_of_commencement', commencementDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="estimated_date_of_completion" id="estimated_date_of_completion" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{estimated_date_of_completion}}" onblur="checkValidation('bocw', 'estimated_date_of_completion', completionDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">10.1 &nbsp;
                                    <input type="checkbox" class="" name="declarationone" id="declarationone" autocomplete="true" value="{{is_checked}}" onblur="checkValidation('bocw', 'declarationone', declarationOneValidationMessage);">&nbsp; I hereby declare that the particulars given above are true to the best of my knowledge and belief
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">10.2 &nbsp;
                                    <input type="checkbox" class="" name="declarationtwo" id="declarationtwo" autocomplete="true" value="{{is_checked}}" onblur="checkValidation('bocw', 'declarationtwo', declarationTwoValidationMessage);">&nbsp; I undertake to abide by the provisions of the Building and other Construction Workers (Regulation of Employment and Conditions of Service) Act, 1996 and the rules made thereunder.
                                    <span style="color: red;">*</span>
                                </span>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="workorder_copy_name_container_for_bocw" style="display: none;">
                            <label>11.  Attach a copy of work order. <span style="color: red;">*<br> (Maximum File Size: 1MB)(Upload pdf Only) <span style="color: red;">*</span></label><br>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_bocw">
                            ...
                            <label class="f-w-n">Document Not Uploaded</label><br>
                            <div class="error-message error-message-dealer-seal_and_stamp_for_bocw"></div>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_bocw" class="btn btn-sm btn-success" onclick="BOCW.listview.submitBOCW({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="BOCW.listview.loadBOCWData();"><i class="fas fa-times"></i> Close</button>
                    </div>
                </div>
            </form>
        </div>
