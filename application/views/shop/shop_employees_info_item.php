<tr id="employees_info_{{item_cnt}}" class="employees_info" style="background-color: #fff;">
    ...
    <td>
        <input type="text" id="employees_name_{{item_cnt}}" name="employees_name_{{item_cnt}}" maxlength="100" class="form-control" placeholder="Employee Name !"
    ...
    <td>
        <input type="text" id="employees_managerial_capacity_{{item_cnt}}" name="employees_managerial_capacity_{{item_cnt}}" class="form-control" placeholder="Managerial Capacity !"
    ...
    <td>
        <input type="text" id="employees_type_{{item_cnt}}" name="employees_type_{{item_cnt}}" class="form-control" placeholder="Employee Type !"
    ...
    <td>
        <input type="text" id="employees_godown_employed_{{item_cnt}}" name="employees_godown_employed_{{item_cnt}}" class="form-control" placeholder="Godown Employed !"
    ...
    <td>
        <input type="radio" id="employees_gender_male_{{item_cnt}}" name="employees_gender_{{item_cnt}}" 
                value="{{VALUE_ONE}}">&nbsp;Male<br>
        
        <input type="radio" id="employees_gender_female_{{item_cnt}}" name="employees_gender_{{item_cnt}}" style="margin-bottom: 0px;"
                value="{{VALUE_TWO}}">&nbsp;Female
        <span class="error-message error-message-shop-employees_gender_{{item_cnt}}"></span>
    </td>
    <td class="text-center">
        <input type="checkbox" id="employees_adult_{{item_cnt}}" name="employees_adult_{{item_cnt}}" class="checkbox1" 
               value="{{is_checked}}">
    </td>
    <td class="text-center">
    ...
    <td class="text-center">
        <button type="button" class="btn btn-xs btn-danger" style="margin-top: 2px;" onclick="Shop.listview.removeEmployeesInfo({{item_cnt}});">
