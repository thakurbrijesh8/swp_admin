<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{s_id}}" onclick="Shop.listview.editOrViewShop($(this),'{{s_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{s_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_THIRTYTHREE,'{{s_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
