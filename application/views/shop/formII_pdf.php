...
<div style="font-size: 14px; text-align: left; margin-bottom: 10px;margin-top: 40px;margin-left:60px;font-weight: bold;">It is hereby certified that<div style="border-bottom:1px solid;margin-left: 185px;margin-top: -20px;width:350px;">&nbsp;</div><div style="margin-left: 540px;margin-top: -20px;">has been</div></div>
...
<div style="font-size: 14px; text-align: right; margin-bottom: 5px;margin-top:90px;font-weight: bold;margin-right: 20px;">Signature of Inspector</div>
