<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="BoilerAct.listview.editOrViewBoilerAct($(this),'{{boiler_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-eye" style="margin-right: 2px;"></i> View</button>
    {{#if show_form_one_btn}}
    <button type="button" class="btn btn-sm btn-danger" 
            onclick="BoilerAct.listview.generateForm1('{{boiler_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_wm_{{boiler_id}}" onclick="BoilerAct.listview.getQueryData('{{boiler_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-question" style="margin-right: 5px;"></i> Raise / View Query</button>
    {{/if}}
    {{#if show_upload_challan_btn}}
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{boiler_id}}"
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{boiler_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{boiler_id}}');"
    ...
    <a class="btn btn-sm btn-nic-blue" target="_blank"
       id="download_certificate_btn_for_app_{{boiler_id}}"
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_THIRTYSEVEN,'{{boiler_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
