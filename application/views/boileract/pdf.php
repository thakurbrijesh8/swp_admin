        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['owner_name']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['situation_of_boiler']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['boiler_type']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['district']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['working_pressure']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['max_pressure']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['heating_surface_area']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['length_of_pipes']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['max_evaporation']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['place_of_manufacture']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['year_of_manufacture']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['name_of_manufacture']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['manufacture_address']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['hydraulically_tested_on']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['hydraulically_tested_to']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['repairs']; ?>
                </td>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $boileract_data['remarks']; ?>
                </td>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;">19</td>
                <td class="second-column">Upload Steam Pipe Line Drawings</td>
                <td class="third-column"><a href ="<?php echo BOILER_DOC_PATH; ?><?php echo $boileract_data['pipe_line_deawing']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;">20</td>
                <td class="second-column">Upload Copy of challan in respect of the fees paid</td>
                <td class="third-column"><a href ="<?php echo BOILER_DOC_PATH; ?><?php echo $boileract_data['copy_of_challan']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
            <tr>
                <td class="first-column" style="height: 30px;">21</td>
                <td class="second-column">Upload IBR Documents</td>
                <td class="third-column"><a href ="<?php echo BOILER_DOC_PATH; ?><?php echo $boileract_data['ibr_document']; ?>" target="_blank"> View Document </a>
                </td>
            </tr>
    </table>
    <br />
    <table style="margin-left: 475px;">
        <tr><td class="border-none"><img src="<?php echo BOILER_DOC_PATH; ?><?php echo $boileract_data['sign_of_applicant']; ?>" height="100px" width="100px"></td></tr>
    </table>
