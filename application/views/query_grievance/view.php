    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="query_grievance_form" name="query_grievance_form" onsubmit="return false;">
                <input type="hidden" id="query_grievance_id" name="query_grievance_id" value="{{query_grievance_id}}">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="district" name="district"
                                    data-placeholder="" onblur="checkValidation('grievance', 'district', queryDistrictValidationMessage);" disabled="">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="issue_category" name="issue_category"
                                    data-placeholder="" onblur="checkValidation('grievance', 'issue_category', issueCategoryValidationMessage);"disabled="">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="department" name="department"
                                    data-placeholder="" onblur="checkValidation('grievance', 'department', queryDepartmentValidationMessage);" disabled="">
                        ...
                        <div class="form-group col-6 mb-3 other_department_div" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="text" id="other_department" name="other_department" class="form-control" placeholder="Enter Other Department Name !"
                                       maxlength="100" onblur="checkValidation('grievance', 'other_department', queryOtherDepartmentValidationMessage);" value="{{other_department}}" readonly="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="full_name" name="full_name" class="form-control" placeholder="Enter Your Full Name !"
                                       maxlength="100" onblur="checkValidation('grievance', 'full_name', applicantFullNameValidationMessage);" value="{{full_name}}" readonly="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="business_name" name="business_name" class="form-control" placeholder="Enter Your Business Name (if any) !"
                                       maxlength="100" value="{{business_name}}" readonly="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="industry_classification" name="industry_classification"
                                    data-placeholder="" onblur="checkValidation('grievance', 'industry_classification', industryClassificationValidationMessage);" disabled="">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="mobile_no" name="mobile_no" class="form-control" placeholder="Enter your Mobile Number  !"
                                       maxlength="100" onblur="checkValidationForMobileNumber('grievance', 'mobile_no', mobileNumberValidationMessage);" value="{{mobile_no}}" readonly="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="email_id" name="email_id" class="form-control" placeholder="Enter your Email Address  !"
                                       maxlength="100" onblur="checkValidationForEmail('grievance', 'email_id', emailValidationMessage);" value="{{email}}" readonly="">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="application_no" name="application_no" class="form-control" placeholder="Enter Submitted Application Number (if Any) !"
                                       maxlength="100" value="{{application_no}}" readonly="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="query" name="query" class="form-control" placeholder="Enter Query !" maxlength="100" onblur="checkValidation('grievance', 'query', queryDetailValidationMessage);" readonly="">{{query}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="query_response" name="query_response" class="form-control" placeholder="Enter Query Response !" maxlength="100" onblur="checkValidation('grievance', 'query_response', queryResponseDetailValidationMessage);" readonly="">{{query_response}}</textarea>
                            </div>
