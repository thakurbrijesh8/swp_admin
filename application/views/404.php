...
<html>
    <head>
        ...
        <title>EODB ADMIN | 404 Page Not Found</title>
            ...
            <div class="content-wrapper">
                <section class="content" style="padding-top: 10%;">
                    <div class="error-page text-center" style="margin: 0px auto 0;">
                        <h1 class="color-nic-blue" style="font-size: 100px;">404</h1>
                        <h3><i class="fas fa-exclamation-triangle color-nic-blue"></i> Oops! Page not found.</h3>
                    </div>
                </section>
            </div>
