                    ...
                    <div class="row">
                        ...
                        <div class=" request_letter_reason_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="request_letter_reason_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="request_letter_reason_doc_name_download" target="_blank"><label id="request_letter_reason_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid blue;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" original_extract_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="original_extract_doc_name_container_for_seller_view" style="display: none;">
                                <label>19.1 Original extract.</label><br>
                                <a id="original_extract_doc_name_download" target="_blank"><label id="original_extract_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" nodue_from_mamlatdar_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="nodue_from_mamlatdar_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="nodue_from_mamlatdar_doc_name_download" target="_blank"><label id="nodue_from_mamlatdar_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" nodue_from_electricity_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="nodue_from_electricity_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="nodue_from_electricity_doc_name_download" target="_blank"><label id="nodue_from_electricity_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" nodue_from_bank_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="nodue_from_bank_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="nodue_from_bank_doc_name_download" target="_blank"><label id="nodue_from_bank_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" nodues_from_grampanchayat_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="nodues_from_grampanchayat_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="nodues_from_grampanchayat_doc_name_download" target="_blank"><label id="nodues_from_grampanchayat_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" challan_of_lease_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="challan_of_lease_doc_name_container_for_seller_view" style="display: none;">
                                ...
                                <a id="challan_of_lease_doc_name_download" target="_blank"><label id="challan_of_lease_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" occupancy_certy_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="occupancy_certy_doc_name_container_for_seller_view" style="display: none;">
                                <label>25.1 Occupancy Certificate.</label><br>
                                <a id="occupancy_certy_doc_name_download" target="_blank"><label id="occupancy_certy_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" nodue_from_excise_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="nodue_from_excise_doc_name_container_for_seller_view" style="display: none;">
                                <label>26.1 No Due Certificate from Central Excise.</label><br>
                                <a id="nodue_from_excise_doc_name_download" target="_blank"><label id="nodue_from_excise_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class=" sign_behalf_lessee_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="sign_behalf_lessee_doc_name_container_for_seller_view" style="display: none;">
                                <label>27.1 Sign on behalf of Lessee/Seller.</label><br>
                                <a id="sign_behalf_lessee_doc_name_download" target="_blank"><label id="sign_behalf_lessee_doc_name_image_for_seller_view" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
