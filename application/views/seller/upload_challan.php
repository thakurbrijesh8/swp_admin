    ...
    <div class="card-body p-b-0px text-left">
        ...
        <div class="row" id="uc_container_for_seller_upload_challan" style="display: none;">
            ...
            <div class="form-group col-sm-12" id="challan_name_container_for_seller_upload_challan" style="display: none;">
                ...
                <span class="fas fa-times" style="color: red; cursor: pointer; margin-left: 3px;" id="challan_remove_btn_for_seller_upload_challan"></span><br>
                {{/if}}
        ...
        <div class="form-group">
            {{#if show_remove_upload_btn}}
            <button type="button" id="submit_btn_for_seller_upload_challan" class="btn btn-sm btn-success" onclick="Seller.listview.uploadChallan();"
