<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="$('#generate_excel_for_site').submit();">
            <i class="fas fa-file-excel" style="margin-right: 2px;"></i>&nbsp; Download Excel</button>
    </div>
    <div class="card-body" id="site_datatable_container">
        <div class="table-responsive">
            <table id="site_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <?php if (is_admin() || is_view_all_district_user()) { ?>
                            <th>
                                <select id="district_for_site_list" class="form-control"
                        ...
                        <th>
                            <input type="text" id="mobile_number_for_site_list" class="form-control" placeholder="Mobile Number" maxlength="10" />
                        </th>
                        <th>
                        ...
                        <th>
                            <select id="app_timing_for_site_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="status_for_site_list" class="form-control"
