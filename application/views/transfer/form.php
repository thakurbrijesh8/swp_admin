            ...
            <form role="form" id="transfer_form" name="transfer_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group"><!-- 
                        ...
                        <button type="button" id="submit_btn_for_transfer" class="btn btn-sm btn-success" onclick="Transfer.listview.submitTransfer({{VALUE_TWO}});" style="margin-right: 5px;">Submit</button>
