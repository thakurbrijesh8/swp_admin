<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{transfer_id}}" onclick="Transfer.listview.editOrViewTransfer($(this),'{{transfer_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{transfer_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_TWELVE,'{{transfer_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{transfer_id}}"
            onclick="Transfer.listview.viewPayment('{{transfer_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{transfer_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{transfer_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{transfer_id}}" onclick="Transfer.listview.askForApproveApplication('{{transfer_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{transfer_id}}"
            onclick="Transfer.listview.askForRejectApplication('{{transfer_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-nic-blue" onclick="Transfer.listview.generateCertificate('{{transfer_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-certificate" style="margin-right: 2px;"></i> Download Certificate</button>
    {{/if}}
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_TWELVE,'{{transfer_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
