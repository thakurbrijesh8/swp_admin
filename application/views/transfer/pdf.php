<html>
    ...
    <body>
        <div style="font-size: 14px; text-align: center;">Sale/Transfer of Lease</div>
        <div style="font-size: 14px; text-align: center; margin-top: 10px;">Application format for Permission Buyer of Lease rights of Government Industrial plots</div>
        <br/>
        <div class="row">
        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $transfer_data['name_of_applicant']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $transfer_data['plot_no']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $transfer_data['govt_Industrial_estate_area']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $transfer_data['survey_no']; ?>
                </td>
            </tr>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo TRANSFER_DOC_PATH; ?><?php echo $transfer_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>
