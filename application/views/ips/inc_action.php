<div class="text-center">
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{ips_incentive_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_FIFTYTWO,'{{ips_incentive_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
