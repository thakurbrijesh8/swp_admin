<?php
$barcode_number = generate_barcode_number(VALUE_FIFTYTWO, $incentive_data['ips_incentive_id']);

$header_array = array();
$header_array['title'] = 'Certificate';
$header_array['department_name'] = 'District Industries Center';
$header_array['district'] = $incentive_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Daman and Diu';
