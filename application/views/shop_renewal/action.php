<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{shop_renewal_id}}" onclick="ShopRenewal.listview.editOrViewShopRenewal($(this),'{{shop_renewal_id}}', true);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i> Edit</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="ShopRenewal.listview.editOrViewShopRenewal($(this),'{{shop_renewal_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{shop_renewal_id}}"
            onclick="ShopRenewal.listview.openUploadChallan('{{shop_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{shop_renewal_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_FOURTYTWO,'{{shop_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{shop_renewal_id}}"
            onclick="ShopRenewal.listview.viewPayment('{{shop_renewal_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{shop_renewal_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{shop_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{shop_renewal_id}}" onclick="ShopRenewal.listview.askForApproveApplication('{{shop_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{shop_renewal_id}}"
            onclick="ShopRenewal.listview.askForRejectApplication('{{shop_renewal_id}}');"
    ...
    <a class="btn btn-sm btn-nic-blue" target="_blank"
       id="download_certificate_btn_for_app_{{shop_renewal_id}}"
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_FOURTYTWO,'{{shop_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
