                  ...
                  <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="license_no" name="license_no" class="form-control" placeholder=" EnterArchitect/ Engineer /Structural License No !" maxlength="100" value="{{construction_data.license_no}}" onblur="checkValidation('construction', 'license_no', architectlicenseNoValidationMessage);">
                            </div>
                     ...
                     <div class="row">
                       <div class="form-group col-sm-6">
                            <label>10. Architect/Engineer/Structural License valid upto</label>
                            <div class="input-group">
                                <input type="text" name="valid_upto_date" id="valid_upto_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{valid_upto_date}}" onblur="checkValidation('construction', 'valid_upto_date', occupancyValidUptoValidationMessage);">
