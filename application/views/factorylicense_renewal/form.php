                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_manager_container_for_fl">
                            <label>10. Signature of Manager of the factory<span style="color: red;"> <br></span></label><br>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_of_occupier_container_for_fl">
                            <label>11. Signature of Occupier of the factory<span style="color: red;"> <br></span></label><br>
