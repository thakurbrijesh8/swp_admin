<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="$('#generate_excel_for_tree_cutting').submit();">
            ...
            <table id="tree_cutting_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if (is_admin() || is_view_all_district_user()) { ?>
                                <select id="district_for_tree_cutting_list" class="form-control"
                        ...
                        <th>
                            <select id="entity_establishment_type_for_tree_cutting_list" class="form-control"
                        ...
                        <th>
                            <select id="app_timing_for_tree_cutting_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="status_for_tree_cutting_list" class="form-control"
                                    data-placeholder="Status !">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="query_status_for_tree_cutting_list" class="form-control"
