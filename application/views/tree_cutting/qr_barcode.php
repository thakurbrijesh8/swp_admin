<?php
$barcode_number = generate_barcode_number(VALUE_FIFTYNINE, $tree_cutting_data['tree_cutting_id']);

$header_array = array();
$header_array['title'] = 'Certificate';
$header_array['department_name'] = 'Forest Department';
$header_array['district'] = $tree_cutting_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Daman and Diu';
