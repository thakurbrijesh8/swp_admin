...
<form role="form" id="approve_msme_form" name="approve_msme_form" onsubmit="return false;" style="font-size: 14px;">
    <input type="hidden" id="msme_id_for_msme_approve" name="msme_id_for_msme_approve" value="{{msme_id}}">
    <div class="card-body p-b-0px text-left">
        ...
        <div class="row">
            <div class="col-12 m-b-5px">
                ...
                <input type="file" id="certificate_file_for_msme_approve" name="certificate_file_for_msme_approve"
                       accept="application/pdf">
                <div class="error-message error-message-msme-approve-certificate_file_for_msme_approve"></div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-12">
