            ...
            <table id="msme_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>
                            <select id="entity_establishment_type_for_msme_list" class="form-control"
                        ...
                        <th>
                            <select id="app_timing_for_msme_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                        ...
                        <th>
                            <select id="query_status_for_msme_list" class="form-control"
