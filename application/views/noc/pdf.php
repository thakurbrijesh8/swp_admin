<html>
    ...
    <body>
        <div style="font-size: 14px; text-align: center;">NOC of Lease</div>
        <div style="font-size: 14px; text-align: center; margin-top: 10px;">Application format for Permission for NOC of Mortgage of lease rights of Government Industrial plots and rent management system</div>
        <br/>
        <div class="row">
        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $noc_data['name_of_applicant']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $noc_data['govt_Industrial_estate_area']; ?>
                </td>
            </tr>
            <tr>
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo NOC_DOC_PATH; ?><?php echo $noc_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>
