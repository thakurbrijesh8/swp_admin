<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{noc_id}}" onclick="Noc.listview.editOrViewNoc($(this),'{{noc_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{noc_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_ELEVEN,'{{noc_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{noc_id}}"
            onclick="Noc.listview.viewPayment('{{noc_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{/if}}
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_ELEVEN,'{{noc_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
