    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="manufacturer_renewal_form" name="manufacturer_renewal_form" onsubmit="return false;">
                <input type="hidden" id="manufacturer_renewal_id" name="manufacturer_renewal_id" value="{{manufacturer_renewal_id}}">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admin_registration_number" name="admin_registration_number" class="form-control" placeholder="Enter Manufacturing License Number !"
                                       maxlength="100" value="{{admin_registration_number}}" readonly onblur="ManufacturerRenewal.listview.getManufacturerData($(this))">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_manufacturer" name="name_of_manufacturer" class="form-control" placeholder="Enter Name of the concern seeking the license !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'name_of_manufacturer', manufacturerNameValidationMessage);" value="{{name_of_manufacturer}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="complete_address" name="complete_address" class="form-control" placeholder="Enter Complete address of the workshop !" maxlength="100" readonly onblur="checkValidation('manufacturer', 'complete_address', workshopAddressValidationMessage);">{{complete_address}}</textarea>
                            </div>
                    ...
                    <div class="col-xs-12 proprietor_info_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product" onclick="ManufacturerRenewal.listview.addMultipleProprietor({});" style="margin-right: 5px;margin-top: 5px;" disabled><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Proprietor
                            </button>
                        </div>
                    </div><br/><br/>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="weights_type" name="weights_type" class="form-control" placeholder="Enter Type of weights and measures which are manufactured as per license granted !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'weights_type', weightTypeValidationMessage);" value="{{weights_type}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="propose_change" name="propose_change" class="form-control" placeholder="Enter any change !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'propose_change', proposeChangeValidationMessage);" value="{{propose_change}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="details_of_foundry" name="details_of_foundry" class="form-control" placeholder="Enter Details of foundry/workshop facilities arranged whether ownership, long term lease etc !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'details_of_foundry', foundryValidationMessage);">{{details_of_foundry}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="production_sales" name="production_sales" class="form-control" placeholder="Enter Details of foundry/workshop facilities arranged whether ownership, long term lease etc !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'production_sales', productionSalesValidationMessage);">{{production_sales}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="registration_date" id="registration_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{registration_date}}" readonly onblur="checkValidation('manufacturer', 'registration_date', shopDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Registration Number of shop/establishment/Municipal Trade License !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'registration_number', shopRegNoValidationMessage);" value="{{registration_number}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" style="margin-top: 22px;" 
                                    data-placeholder="Status !" name="identity_choice" id="identity_choice" readonly onblur="checkValidation('manufacturer', 'identity_choice', identityChoiceValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="identity_number" name="identity_number" class="form-control" placeholder="Enter Vat/Sales Tax Registration Numbers/CST Number/Professional Tax registration Number/It Number !"
                                       maxlength="100" readonly onblur="checkValidation('manufacturer', 'identity_number', identityNoValidationMessage);" value="{{identity_number}}">
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">20. &nbsp;
                                    <input type="checkbox" class="" name="declarationtwo" id="declarationtwo" autocomplete="true" value="{{is_checked}}" disabled onblur="checkValidation('manufacturer', 'declarationtwo', declarationTwoValidationMessage);">&nbsp;I/We agree to deposit the Scheduled license fees with Government as soon as required to do so by the Licensing Authority.
                                    <span style="color: red;">*</span>
                                </span>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">21. &nbsp;
                                    <input type="checkbox" class="" name="declarationthree" id="declarationthree" autocomplete="true" value="{{is_checked}}" disabled onblur="checkValidation('manufacturer', 'declarationthree', declarationThreeValidationMessage);">&nbsp;All the information furnished above is true to the best of my/our knowledge.
                                    <span style="color: red;">*</span>
                                </span>
                            </div>
