<?php
$barcode_number = generate_barcode_number(VALUE_SIXTEEN, $manufacturer_renewal_data['manufacturer_renewal_id']);
...
<div style="font-size: 14px; text-align: center;font-weight:  bold;">FORM LM 3</div>
...
<div style="font-size: 14px; text-align: center; margin-top: 20px;margin-left: 50px;word-spacing: 4px;"> LICENSE TO MANUFACTURER WEIGHTS, MEASURES, WEIGHING INSTRUMENTS OR MEASURING INSTRUMENTS</div>
<div style="font-size: 14px; text-align: left;word-spacing: 10px;">license No : <?php echo $manufacturer_renewal_data['admin_registration_number']; ?></div>
<div style="font-size: 14px; text-align: right; margin-bottom: 5px;">Year : &emsp;<?php echo date("Y"); ?></div>

<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(1)&emsp;&emsp;The controller of legal metrology hereby grants to<b> <?php echo $manufacturer_renewal_data['name_of_manufacturer']; ?>&nbsp;&nbsp;<?php echo $manufacturer_renewal_data['complete_address']; ?></b> a license to repair the following :-<br/>(Include details of the types of weights,measures,weighing instruments or measuring instruments that are license to be reapaired by the party).</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(2)&emsp;&emsp;The license is valid for the party named above in respect of his workshop located at <?php echo $manufacturer_renewal_data['complete_address']; ?>.</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(3)&emsp;&emsp;The license is valid upto <?php echo date('d/m/Y',strtotime($manufacturer_renewal_data['valid_upto'])); ?> .</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(4)&emsp;&emsp;The manufacturer shall comply with the conditions noted below. If he fails to company with any one, his license is liable to be cancelled .</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(5)&emsp;&emsp;The tread mark monogram being used by the manufacturer is as under -</div>
<br />
<table style="margin-left: 490px;">
    <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/manufacturer/<?php echo  $manufacturer_renewal_data['mw_sign_of_principal_employer']; ?>" height="60px" width="90px"></td></tr>
</table>
...
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(e)&emsp;&emsp;Present the weights, measures, weighing or measuring instruments as the case may be manuafctured and meant for used within the state,to the legal metrology officer for verification satmping before sale;</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(f)&emsp;&emsp;Submit the application for renewal of this licence as required under the rules within thirty days of expiry of the validity of the licence.</div>
<br />
<div style="font-size: 14px;text-align: left;margin-top: 5px;word-spacing: 5px;">(g)&emsp;&emsp;Not sell or offer,expose or possess for sale any non-standard weight or measure.</div>   
<br/>
