    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;">Application Form for Grant Performance License for Tourism Event</div>
            </div>
            <form role="form" id="tourismevent_form" name="tourismevent_form" onsubmit="return false;">

                <input type="hidden" id="tourismevent_id" name="tourismevent_id" value="{{tourismevent_data.tourismevent_id}}">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <span class="error-message error-message-tourismevent-district"></span>
                        </div>
                        <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_person" name="name_of_person" class="form-control" placeholder="Name of person/Agency proposing to carry out the event !" maxlength="100" value="{{tourismevent_data.name_of_person}}" 
                                       onblur="checkValidation('tourismevent', 'name_of_person', personNameValidationMessage);">
                            </div>
                            <span class="error-message error-message-tourismevent-name_of_person"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_event" name="name_of_event" class="form-control" placeholder="Name of the event !" maxlength="100" value="{{tourismevent_data.name_of_event}}" 
                                       onblur="checkValidation('tourismevent', 'name_of_event', nameOfEventValidationMessage);">
                            </div>
                            <span class="error-message error-message-tourismevent-name_of_event"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>4. Location of the event <span style="color: red;">*</span></label>
                            <div class="input-group">
                                <input type="text" id="location_of_event" name="location_of_event" class="form-control" placeholder="Location of the event !" maxlength="100" value="{{tourismevent_data.location_of_event}}" onblur="checkValidation('tourismevent', 'location_of_event', locationOfEventValidationMessage);">
                            </div>
                            <span class="error-message error-message-tourismevent-location_of_event"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date ">
                                <input type="text" name="date_of_event" id="date_of_event" class="form-control date_picker" placeholder="DD-MM-YYYY" data-date-format="DD-MM-YYYY"
                                       value="{{date_of_event}}" onblur="checkValidation('tourismevent', 'date_of_event', dateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                            <span class="error-message error-message-tourismevent-date_of_event"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="bootstrap-timepicker">
                                <div class="form-group">
                                    <div class="input-group date " id="timepicker" data-target-input="nearest">
                                        <input type="text" name="time_of_event" id="time_of_event" class="form-control datetimepicker-input timepicker" data-target="#timepicker" onblur="checkValidation('tourismevent', 'time_of_event', timeOfEventValidationMessage);"
                                               value="{{tourismevent_data.time_of_event}}" maxlength="10" placeholder="00:00 AM">
                                        <div class="input-group-append" data-target="#timepicker" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="far fa-clock"></i></div>
                                        </div>
                                    </div>
                                    <span class="error-message error-message-tourismevent-time_of_event"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="duration_of_event" name="duration_of_event" class="form-control" placeholder="Duration of the event !" maxlength="10"value="{{tourismevent_data.duration_of_event}}" onblur="checkValidation('tourismevent', 'duration_of_event', durationOfEventValidationMessage);"
                                       value="{{tourismevent_data.duration_of_event}}">
                            </div>
                            <span class="error-message error-message-tourismevent-duration_of_event"></span>
                        </div>
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="mob_no" name="mob_no" class="form-control" placeholder=" Mobile No. !"
                                   maxlength="10" onblur="checkNumeric($(this)); checkValidationForMobileNumber('tourismevent', 'mob_no', mobileValidationMessage);" value="{{tourismevent_data.mob_no}}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="proposal_details_document_name_container_for_tourismevent" style="display: none;">
                            <label>9. Upload the detailed proposal and particulars of the event <span style="color: red;">* </label><br>
                            <a target="_blank" id="proposal_details_document_download"><label id="proposal_details_document_name_image_for_tourismevent" style="border: 2px solid black;" class="btn btn-sm btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
