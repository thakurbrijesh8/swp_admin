<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: center;font-weight:  bold;">DEPARTMENT OF LEGAL METROLOGY (WEIGHTS & MEASURES), DAMAN & DIU</div><br/>
        ...
        <table style="margin-left: 490px;">
            <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/subletting/<?php echo  $subletting_data['mw_sign_of_principal_employer']; ?>" height="60px" width="90px"></td></tr>
        </table>
