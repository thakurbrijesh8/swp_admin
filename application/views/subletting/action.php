<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="Subletting.listview.editOrViewSubletting($(this),'{{subletting_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{subletting_id}}" onclick="Subletting.listview.askForApproveApplication('{{subletting_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{subletting_id}}"
            onclick="Subletting.listview.askForRejectApplication('{{subletting_id}}');"
