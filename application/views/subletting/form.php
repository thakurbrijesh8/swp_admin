            ...
            <form role="form" id="subletting_form" name="subletting_form" onsubmit="return false;">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                        data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('subletting', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                                </select>
                            </div>
                            <span class="error-message error-message-subletting-entity_establishment_type"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class=" request_letter_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="request_letter_premises_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="request_letter_premises_download" target="_blank"><label id="request_letter_premises_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" original_extract_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="original_extract_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="original_extract_certificate_download" target="_blank"><label id="original_extract_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" land_revenue_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="land_revenue_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="land_revenue_certificate_download" target="_blank"><label id="land_revenue_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" electricity_bill_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="electricity_bill_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="electricity_bill_certificate_download" target="_blank"><label id="electricity_bill_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" bank_loan_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="bank_loan_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="bank_loan_certificate_download" target="_blank"><label id="bank_loan_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" panchayat_tax_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="panchayat_tax_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="panchayat_tax_certificate_download" target="_blank"><label id="panchayat_tax_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" challan_of_lease_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="challan_of_lease_rent_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="challan_of_lease_rent_download" target="_blank"><label id="challan_of_lease_rent_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" occupancy_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="occupancy_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="occupancy_certificate_download" target="_blank"><label id="occupancy_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class=" central_excise_div" style="display: none;">
                            ...
                            <div class="form-group col-sm-12" id="central_excise_certificate_name_container_for_subletting" style="display: none;">
                                ...
                                <a id="central_excise_certificate_download" target="_blank"><label id="central_excise_certificate_name_image_for_subletting" class="btn btn-sm btn-nic-blue f-w-n" style="border: 2px solid black;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_wmregistration" class="btn btn-sm btn-success" onclick="Subletting.listview.submitSubletting({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="showTableContainer('subletting');"><i class="fas fa-times"></i> Close</button>
                    </div>
                </div>
            </form>
        </div>
