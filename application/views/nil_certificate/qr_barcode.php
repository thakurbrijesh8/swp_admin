<?php
$barcode_number = generate_barcode_number(VALUE_SIXTYONE, $nil_certificate_data['nil_certificate_id']);

$header_array = array();
$header_array['title'] = 'Certificate';
$header_array['department_name'] = 'Civil Registrar Cum Sub Registrar';
$header_array['district'] = $nil_certificate_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Daman and Diu';
