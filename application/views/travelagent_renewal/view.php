    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="travelagent_renewal_form" name="travelagent_renewal_form" onsubmit="return false;">
                ...
                <input type="hidden" id="travelagent_renewal_id" name="travelagent_renewal_id" value="{{travelagent_renewal_id}}">
                <input type="hidden" id="travelagentregi_id" name="travelagentregi_id" value="{{travelagentregi_id}}">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_travel_agency" name="name_of_travel_agency" class="form-control" placeholder="Name of Travel Agency !"
                                       maxlength="100" disabled="" value="{{name_of_travel_agency}}">
                            </div>
