<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{travelagent_renewal_id}}" onclick="TravelagentRenewal.listview.editOrViewTravelagentRenewal($(this),'{{travelagent_renewal_id}}', true);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i> Edit</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="TravelagentRenewal.listview.editOrViewTravelagentRenewal($(this),'{{travelagent_renewal_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-eye" style="margin-right: 2px;"></i> View</button>
    {{#if show_form_one_btn}}
    <button type="button" class="btn btn-sm btn-danger" 
            onclick="TravelagentRenewal.listview.generateForm('{{travelagent_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_wm_{{travelagent_renewal_id}}" onclick="TravelagentRenewal.listview.getQueryData('{{travelagent_renewal_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-question" style="margin-right: 5px;"></i> Raise / View Query</button>
    {{/if}}
    {{#if show_upload_challan_btn}}
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{travelagent_renewal_id}}"
            onclick="TravelagentRenewal.listview.openUploadChallan('{{travelagent_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{travelagent_renewal_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_TWENTYTHREE,'{{travelagent_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{travelagent_renewal_id}}"
            onclick="TravelagentRenewal.listview.viewPayment('{{travelagent_renewal_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{travelagent_renewal_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{travelagent_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{travelagent_renewal_id}}" onclick="TravelagentRenewal.listview.askForApproveApplication('{{travelagent_renewal_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{travelagent_renewal_id}}"
