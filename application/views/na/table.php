<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="$('#generate_excel_for_na').submit();">
            <i class="fas fa-file-excel" style="margin-right: 2px;"></i>&nbsp; Download Excel</button>
    </div>
    <div class="card-body" id="na_datatable_container">
            ...
            <table id="na_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>
                            <select id="entity_establishment_type_for_na_list" class="form-control"
                        ...
                        <th>
                            <input type="text" class="form-control" placeholder="Applicant Name or Occupation" />
                        </th>
                        <th>
                            <select id="app_timing_for_na_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                        ...
                        <th>
                            <select id="query_status_for_na_list" class="form-control"
