    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="na_form" name="na_form" onsubmit="return false;">
                ...
                <input type="hidden" id="na_id" name="na_id" value="{{na_data.na_id}}">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                    data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('na', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                            </select>
                            </div>
                            <span class="error-message error-message-na-entity_establishment_type"></span>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        ...
                        <div class="box-footer" align="right" style="margin-bottom: 50px;" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_applicant" onclick="Na.listview.addMultipleApplicant({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Applicant
                            </button>
                        </div>
                    </div>
                    <div class="col-xs-12">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="agri_purpose_a" name="agri_purpose_a" class="form-control"
                                                       maxlength="200" value="{{na_data.agri_purpose_a}}">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="non_agri_purpose_b" name="non_agri_purpose_b" class="form-control"
                                                       maxlength="100" value="{{na_data.non_agri_purpose_b}}">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="non_agri_purpose_c" name="non_agri_purpose_c" class="form-control" 
                                                       maxlength="200"  value="{{na_data.non_agri_purpose_c}}">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="rel_condition_c" name="rel_condition_c" class="form-control" 
                                                       maxlength="200" value="{{na_data.rel_condition_c}}">
                                            </div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="text" id="pre_non_agri_c" name="pre_non_agri_c" class="form-control" 
                                                       maxlength="200" value="{{na_data.pre_non_agri_c}}">
                                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_applicant" name="name_of_applicant" class="form-control" placeholder="Name of Applicant !"
                                       maxlength="100" onblur="checkValidation('na', 'name_of_applicant', applicantNameValidationMessage);" value="{{na_data.name_of_applicant}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea type="text" id="postel_address" name="postel_address" class="form-control" placeholder="Full Postal address !"
                                          onblur="checkValidation('na', 'postel_address', addressValidationMessage);">{{na_data.postel_address}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="occupation" name="occupation" class="form-control" placeholder="Occupation !" maxlength="100" value="{{na_data.occupation}}" onblur="checkValidation('na', 'occupation', occupationValidationMessage);">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="village" name="village" value="{{na_data.village}}" maxlength="100"
                        ...
                        <!--                        <div class="form-group col-sm-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" id="purpose" name="purpose" class="form-control" placeholder="Assessed or held for the purpose of agriculture for the non-agricultureal purpose/purposes !" maxlength="100" value="{{na_data.purpose}}" onblur="checkValidation('na', 'purpose', naPurposeValidationMessage);">
                                                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="survey_no" name="survey_no" maxlength="100" value="{{na_data.survey_no}}" placeholder="Survey No. Hissa No. of the land !" onblur="checkValidation('na', 'survey_no', naSurveyNoValidationMessage);">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="area_assessment" name="area_assessment" value="{{na_data.area_assessment}}" placeholder="Area and assessment/rent of the land !" maxlength="100" onblur="checkValidation('na', 'area_assessment', naAreaAssessmentValidationMessage);">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="area_of_site_used" name="area_of_site_used" value="{{na_data.area_of_site_used}}" placeholder="Area of the site !" maxlength="100" onblur="checkValidation('na', 'area_of_site_used', naAreaSiteValidationMessage);">
                            </div>
<!--                            <select class="form-control" id="area_of_site_used" name="area_of_site_used"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="occupant_class" name="occupant_class" maxlength="100" value="{{na_data.occupant_class}}" placeholder="Whether the applicant is occupant Class-I or Class-II or a tenant or a government lessee. !" onblur="checkValidation('na', 'occupant_class', naOccupantClassValidationMessage);">
                            </div>
<!--                            <select class="form-control" id="occupant_class" name="occupant_class"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" id="present_use_land" name="present_use_land" value="{{na_data.present_use_land}}"
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="situated_land" name="situated_land" value="{{na_data.situated_land}}" maxlength="100" placeholder=" Whether the land is Situated or Included !" onblur="checkValidation('na', 'situated_land', naSituatedLandValidationMessage);">
                            </div>
...
<!--                            <input type="radio" id="electrical_distance_land_yes" name="electrical_distance_land"  
                        ...
                        <div class="form-group col-sm-6"><br>
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="acquisition_under_land" name="acquisition_under_land" maxlength="100" value="{{na_data.acquisition_under_land}}" placeholder="Is the land under acquisitions if so, state details !" onblur="checkValidation('na', 'acquisition_under_land', naAcquisitionsUnderLandValidationMessage);">
                            </div>
<!--                            <input type="radio" id="acquisition_under_land_yes" name="acquisition_under_land"  
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="accessible_land" name="accessible_land" maxlength="100" value="{{na_data.accessible_land}}" placeholder="Is there a road from where the land is easily accessible ?" onblur="checkValidation('na', 'accessible_land', naAccessibleLandValidationMessage);">
                            </div>
<!--                            <input type="radio" id="accessible_land_yes" name="accessible_land"  
                        ...
                        <div class="form-group col-sm-6"><br>
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="site_access_land" name="site_access_land" maxlength="100" value="{{na_data.site_access_land}}" placeholder="If there is no road adjoining the land how is it proposed to provide for access to the site ?" onblur="checkValidation('na', 'site_access_land', naSiteAccessLandValidationMessage);">
                            </div>
<!--                            <input type="radio" id="site_access_land_yes" name="site_access_land"  
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="rejected_land" name="rejected_land" maxlength="100" value="{{na_data.rejected_land}}" placeholder="Was a similar application made in the past for non-agricultural use of this land and was it rejected?" onblur="checkValidation('na', 'rejected_land', naRejectedLandValidationMessage);">
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea type="text" id="postel_address" name="postel_address" class="form-control" placeholder="Full Postal address !"
                                          maxlength="100" onblur="checkValidation('na', 'postel_address', addressValidationMessage);">{{na_data.postel_address}}</textarea>
                            </div>
                            <span class="error-message error-message-na-postel_address"></span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="village" name="village" value="{{na_data.village}}"
                                       placeholder="Village Taluka where the land is situated !" onblur="checkValidation('na', 'village', villageValidationMessage);">
                            </div>
                            <span class="error-message error-message-na-village"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input class="form-control" id="survey_no" name="survey_no" value="{{na_data.survey_no}}" placeholder="Survey No. Hissa No. area and assessment/rent of the land !" onblur="checkValidation('na', 'survey_no', naSurveyNoValidationMessage);">
                            </div>
                            <span class="error-message error-message-na-survey_no"></span>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <select class="form-control" id="occupant_class" name="occupant_class"
                                    data-placeholder="Whether the applicant is occupant Class-I or Class-II or a tenamt or a government lessee. !" onblur="checkValidation('na', 'occupant_class', naOccupantClassValidationMessage);">
                                <option value="">Select occupant class</option>
                                <option value="Class-I">Class-I</option>
                                <option value="Class-II">Class-II</option>
                            </select>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input class="form-control" id="present_use_land" name="present_use_land" value="{{na_data.present_use_land}}"
                                   placeholder="Present use of the land whether any building exists thereon and if so its use !" onblur="checkValidation('na', 'present_use_land', naPresentUseValidationMessage);">
                            <span class="error-message error-message-na-present_use_land"></span>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="radio" id="accessible_land_yes" name="accessible_land"  
                                   onblur="checkValidation('hotelregi', 'accessible_land', naAccessibleLandValidationMessage);" value="{{IS_CHECKED_YES}}"> YES &emsp; 
                            <input type="radio" id="accessible_land_no" name="accessible_land" 
                                   maxlength="100" onblur="checkValidation('hotelregi', 'accessible_land', naAccessibleLandValidationMessage);" value="{{IS_CHECKED_NO}}"> NO
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input type="radio" id="site_access_land_yes" name="site_access_land"  
                                   maxlength="100" onblur="checkValidation('hotelregi', 'site_access_land', naSiteAccessLandValidationMessage);" value="{{IS_CHECKED_YES}}"> YES &emsp; 
                            <input type="radio" id="site_access_land_no" name="site_access_land" 
                                   maxlength="100" onblur="checkValidation('hotelregi', 'site_access_land', naSiteAccessLandValidationMessage);" value="{{IS_CHECKED_NO}}"> NO
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <input type="radio" id="rejected_land_yes" name="rejected_land"  
                                   onblur="checkValidation('hotelregi', 'rejected_land', naRejectedLandValidationMessage);" value="{{IS_CHECKED_YES}}"> YES &emsp; 
                            <input type="radio" id="rejected_land_no" name="rejected_land" 
                                   maxlength="100" onblur="checkValidation('hotelregi', 'rejected_land', naRejectedLandValidationMessage);" value="{{IS_CHECKED_NO}}"> NO
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_na" style="display: none;">
                            <label>19. Principal Employer Seal & Stamp <span style="color: red;">*</label><br>
                            <a target="_blank" id="seal_and_stamp_download"><img id="seal_and_stamp_name_image_for_na" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                    <div class="row">
