<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{na_id}}" onclick="Na.listview.editOrViewNa($(this),'{{na_id}}', true);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i> Edit</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="Na.listview.editOrViewNa($(this),'{{na_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-eye" style="margin-right: 2px;"></i> View</button>
    {{#if show_form_one_btn}}
    <button type="button" class="btn btn-sm btn-danger" 
            onclick="Na.listview.generateForm('{{na_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_na_{{na_id}}" onclick="Na.listview.getQueryData('{{na_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-question" style="margin-right: 5px;"></i> Raise / View Query</button>
    {{/if}}
    {{#if show_upload_challan_btn}}
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{na_id}}"
            onclick="Na.listview.openUploadChallan('{{na_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{na_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_FOURTY,'{{na_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{na_id}}"
            onclick="Na.listview.viewPayment('{{na_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{na_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{na_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{na_id}}" onclick="Na.listview.askForApproveApplication('{{na_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{na_id}}"
            onclick="Na.listview.askForRejectApplication('{{na_id}}');"
    ...
    <a class="btn btn-sm btn-nic-blue" target="_blank"
       id="download_certificate_btn_for_app_{{na_id}}"
