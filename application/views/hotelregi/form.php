    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;">UT OF DADRA AND NAGAR & DAMAN AND DIU </div>
            ...
            <form role="form" id="hotelregi_form" name="hotelregi_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="hotel" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-12 m-b-5px" id="construction_plan_container_for_hotelregi">
                                <!--<label>15. Copies of Form 1 & XIV of lands. <span style="color: red;">* <br>(Maximum File Size: 1MB) &nbsp; (Upload PDF Only)</span></label><br>-->
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-sm btn-danger" onclick="showTableContainer('hotelregi');"><i class="fas fa-times"></i> Close</button>
                    </div>
                </div>
            </form>
        </div>
