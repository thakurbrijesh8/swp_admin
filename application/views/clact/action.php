<div class="text-center">
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{establishment_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_THIRTYONE,'{{establishment_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_THIRTYONE,'{{establishment_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
