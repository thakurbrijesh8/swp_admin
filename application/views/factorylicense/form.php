                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="form_two_copy_name_container_for_fl" style="display: none;">
                            <label>21.  Form II along with the paid challans.<span style="color: red;">*<br></label><br>
                            <a id="form_two_copy_name_download" target="_blank" ><label id="form_two_copy_name_image_for_fl" class="btn-nic-blue f-w-n" style="border: 2px solid black;padding: 4px 4px 4px 4px;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="occupancy_certificate_name_container_for_fl" style="display: none;">
                            <label>22. Occupancy Certificate.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="stability_certificate_name_container_for_fl" style="display: none;">
                            <label>23. Certificate regarding stability of the structure form a qualified structural engineer.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="safety_equipments_list_name_container_for_fl" style="display: none;">
                            <label>24. List of safety equipments / precautionary measures taken on site. ( on company’s letterhead and signed ).<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="machinery_layout_name_container_for_fl" style="display: none;">
                            <label>25.  Machinery layout drawing architect approved.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="approved_plan_copy_name_container_for_fl" style="display: none;">
                            <label>26.   A copy of the approved plan.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="safety_provision_name_container_for_fl" style="display: none;">
                            <label>27. Provisions of Health, Safety and Welfare under the Factory Act, 1948.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="copy_of_site_plans_name_container_for_fl" style="display: none;">
                            <label>28. A copy of ON SITE/OFF SITE PLANS if applicable/ signed statement on company’s letterhead that it is not applicable.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="plan_approval_name_container_for_fl" style="display: none;">
                            <label>29. Approval of the plans from the Chief Controller of Explosives, Nagpur in respect of the storage of Petroleum and Hazardous substances, if applicable /signed statement on company’s letterhead that it is not applicable.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="self_certificate_name_container_for_fl" style="display: none;">
                            <label>30. Self Certification by the Management whether the premises is Owned/Leased.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="project_report_name_container_for_fl" style="display: none;">
                            <label>31. Project Report (including flow chart) (Signed).<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="land_document_copy_name_container_for_fl" style="display: none;">
                            <label>32. Copy of land document (Form I & XIV).<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="ssi_registration_copy_name_container_for_fl" style="display: none;">
                            <label>33. A Copy of SSI Registration/Industrial Licence /In principle clearance in case of MSI/LSL.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="detail_of_etp_name_container_for_fl" style="display: none;">
                            <label>34.  Details of ETP, if any, (On company letterhead and signed).<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="questionnaire_copy_name_container_for_fl" style="display: none;">
                            <label>35.  A copy of Questionnaire duly filled and signed by the Manager and the Occupier.<span style="color: red;">*<br></label><br>
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="seal_and_stamp_container_for_fl">
                            <label>36. Signature of Occupier<span style="color: red;">* <br></span></label><br>
                            <input type="file" id="seal_and_stamp_for_fl" name="seal_and_stamp_for_fl"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif">
                            <div class="error-message error-message-dealer-seal_and_stamp_for_fl"></div>
                        </div>
                        <div class="form-group col-sm-12" id="seal_and_stamp_name_container_for_fl" style="display: none;">
                            <label>36. Signature of Occupier<span style="color: red;">* <br></span></label><br>
                            <!-- <img id="seal_and_stamp_name_image_for_fl" style="width: 250px; height: 250px; border: 2px solid blue;"> -->
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_factory" class="btn btn-sm btn-success" onclick="FactoryLicense.listview.submitFactoryLicense({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
