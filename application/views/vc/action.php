<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{vc_id}}" onclick="VC.listview.editOrViewVC($(this),'{{vc_id}}', true);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i> Edit</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="VC.listview.editOrViewVC($(this),'{{vc_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{vc_id}}"
            onclick="VC.listview.openUploadChallan('{{vc_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{vc_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_FOURTYEIGHT,'{{vc_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-undo" style="margin-right: 2px;"></i> Withdraw</button>
    {{/if}}
    {{#if show_download_fees_paid_challan_btn}}
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{vc_id}}"
            onclick="VC.listview.viewPayment('{{vc_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{vc_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{vc_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{vc_id}}" onclick="VC.listview.askForApproveApplication('{{vc_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{vc_id}}"
            onclick="VC.listview.askForRejectApplication('{{vc_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-nic-blue" id="download_certificate_btn_for_app_{{vc_id}}"
            onclick="VC.listview.generateCertificate('{{vc_id}}');"
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_FOURTYEIGHT,'{{vc_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
