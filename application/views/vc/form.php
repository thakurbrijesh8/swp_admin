    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="vc_form" name="vc_form" onsubmit="return false;">
                ...
                <input type="hidden" id="vc_id" name="vc_id" value="{{vc_data.vc_id}}">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                    data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('vc', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                            </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_applicant" name="name_of_applicant" class="form-control" placeholder="Name of Applicant /Premises  !"
                                       maxlength="100" onblur="checkValidation('vc', 'name_of_applicant', applicantNameValidationMessage);" value="{{vc_data.name_of_applicant}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="address" name="address" class="form-control" placeholder="Enter address !" maxlength="500" onblur="checkValidation('vc', 'address', addressValidationMessage);">{{vc_data.address}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <div class="input-group">
                                <input type="text" id="capacity" name="capacity" class="form-control" placeholder="Capacity !"
                                       maxlength="100" onblur="checkValidation('vc', 'capacity', capacityValidationMessage);" value="{{vc_data.capacity}}">
                                &nbsp;<select id="capacity_type" name="capacity_type" class="form-control select2"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="make" name="make" class="form-control" placeholder="Make !"
                                   maxlength="200" onblur="checkValidation('vc', 'make', diameterServiceConnectionValidationMessage);" value="{{vc_data.make}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="model_no" name="model_no" class="form-control" placeholder="Enter Model No. !"
                                   maxlength="100" onblur="checkValidation('vc', 'model_no', modelNoValidationMessage);" value="{{vc_data.model_no}}">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" id="serial_no" name="serial_no" class="form-control" placeholder="Enter Serial No. !"
                                   maxlength="100" onblur="checkValidation('vc', 'serial_no', serialNoValidationMessage);" value="{{vc_data.serial_no}}">
                            <span class="error-message error-message-vc-serial_no"></span>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>12. Verification Place <span style="color: red;">*</span></label>
                            <div class="input-group">
                                <select id="verification_at" name="verification_at" class="form-control select2"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="quantity_units" name="quantity_units" class="form-control select2"
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_vc" class="btn btn-sm btn-success" onclick="VC.listview.submitVC({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="VC.listview.loadVCData();"><i class="fas fa-times"></i> Close</button>
                    </div>
                </div>
            </form>
        </div>
