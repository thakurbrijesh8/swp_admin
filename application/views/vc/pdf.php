<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: left; margin-bottom: 12px;margin-left:  290px;">Date :-&nbsp;<div style="margin-left:  50px;margin-top: -20px;border-bottom: 1px solid black;width: 350px; ">&emsp;<?php echo convert_to_new_date_format($vc_data['created_time']); ?></div></div>
        <div class="row">
        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $vc_data['name_of_applicant']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $vc_data['panchayat_or_dmc']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $vc_data['application_category']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $vc_data['house_ownership']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column"><br/>
                    <?php echo $vc_data['diameter_service_connection']; ?><br/>
                </td>
            </tr>
            <tr>
        ...
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo WC_DOC_PATH; ?><?php echo $vc_data['signature']; ?>" height="80px" width="80px"></div>
