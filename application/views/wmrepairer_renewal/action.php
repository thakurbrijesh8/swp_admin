<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{repairer_renewal_id}}" onclick="RepairerRenewal.listview.editOrViewRepairerRenewal($(this),'{{repairer_renewal_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{repairer_renewal_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_FOURTEEN,'{{repairer_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-nic-blue" id="download_certificate_btn_for_app_{{repairer_renewal_id}}"
        ...
        <i class="fas fa-certificate" style="margin-right: 2px;"></i> Download Certificate</button>
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_FOURTEEN,'{{repairer_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
