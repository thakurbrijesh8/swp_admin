    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="repairer_renewal_form" name="repairer_renewal_form" onsubmit="return false;">
                ...
                <input type="hidden" id="repairer_renewal_id" name="repairer_renewal_id" value="{{repairer_renewal_data.repairer_renewal_id}}">
                <input type="hidden" id="repairer_id" name="repairer_id" value="{{repairer_renewal_data.repairer_id}}">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admin_registration_number" name="admin_registration_number" class="form-control" placeholder="Enter Repairer's License Number !"
                                       maxlength="100" value="{{repairer_renewal_data.admin_registration_number}}" onblur="RepairerRenewal.listview.getRepairerData($(this));checkValidation('repairer', 'admin_registration_number', licenseNumberValidationMessage);">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_repairmen" name="name_of_repairmen" class="form-control" placeholder="Enter Name of the concern seeking the license !"
                                       maxlength="100" onblur="checkValidation('repairer', 'name_of_repairmen', repairmenNameValidationMessage);" value="{{repairer_renewal_data.name_of_repairer}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="complete_address" name="complete_address" class="form-control" placeholder="Enter Complete address of the workshop !" maxlength="100" onblur="checkValidation('repairer', 'complete_address', workshopAddressValidationMessage);">{{repairer_renewal_data.complete_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Registration Number of shop/establishment/Municipal Trade License !"
                                       maxlength="100" onblur="checkValidation('repairer', 'registration_number', shopRegNoValidationMessage);" value="{{repairer_renewal_data.registration_number}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="identity_number" name="identity_number" class="form-control" placeholder="Enter Vat/Sales Tax Registration Numbers/CST Number/Professional Tax registration Number/It Number !"
                                       maxlength="100" onblur="checkValidation('repairer', 'identity_number', identityNoValidationMessage);" value="{{repairer_renewal_data.identity_number}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="weights_type" name="weights_type" class="form-control" placeholder="Enter The type of weights and measures proposed to be repaired !"
                                       maxlength="100" onblur="checkValidation('repairer', 'weights_type', weightTypeValidationMessage);" value="{{repairer_renewal_data.weights_type}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="propose_change" name="propose_change" class="form-control" placeholder="Enter any change !"
                                       maxlength="100" onblur="checkValidation('repairer', 'propose_change', proposeChangeValidationMessage);" value="{{repairer_renewal_data.propose_change}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="area_operate" name="area_operate" class="form-control" placeholder="Enter Area in which you wish to operate !"
                                       maxlength="100" onblur="checkValidation('repairer', 'area_operate', areaOperateValidationMessage);" value="{{repairer_renewal_data.area_operate}}">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 stock_details_div" style="display: none;">
                            ...
                            <div class="input-group">
                                <textarea id="stock_details" name="stock_details" class="form-control" placeholder="Enter Stock Details !" maxlength="100" onblur="checkValidation('repairer', 'stock_details', stockDetailValidationMessage);">{{repairer_renewal_data.stock_details}}</textarea>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_repairer" class="btn btn-sm btn-success" onclick="RepairerRenewal.listview.submitRepairerRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
