...
<div class="card-body p-b-0px text-left" style="font-size: 14px;">
    ...
    <div class="row" id="vp_container_for_aplicence_renewal" style="display: none;">
        <div class="form-group col-sm-12">
            <label><span class="utitle_for_aplicence_renewal">{{utitle}}</span> <span style="color: red;">*</label><br>
            <a id="fees_paid_challan_name_href_for_aplicence_renewal" target="_blank">
                <i class="fas fa-cloud-download-alt" style="margin-right: 3px;"></i><span id="fees_paid_challan_name_for_aplicence_renewal"></span>
            </a>
        </div>
    </div>
