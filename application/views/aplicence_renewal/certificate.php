<?php
$barcode_number = generate_barcode_number(VALUE_FOURTYSIX, $ex_data['aplicence_renewal_id']);

$header_array = array();
$header_array['title'] = 'FORM - IV';
...
<div style="font-size: 14px; text-align: center; margin-top: 10px;font-weight: bold;">ADMINISTRATION OF <?php echo $ex_data['district'] == VALUE_THREE ? 'DADRA AND NAGAR HAVELI' : 'DAMAN AND DIU'; ?></div>
...
<div style="font-size: 14px; text-align: left;margin-left: 10px; margin-bottom: 20px;word-spacing: 5px;margin-top: 20px;font-weight: bold;">License No.<div style="margin-left: 95px;margin-top: -18px;"> <?php echo $ex_data['registration_number']; ?></div>
    <div style="font-size: 14px; text-align: left;margin-left: 310px; margin-top: -20px;word-spacing: 8px;font-weight: bold;">Dated <div style="margin-left: 45px;margin-top: -20px;">:- <?php echo convert_to_new_date_format($ex_data['date_of_certificate']); ?></div>
        <div style="font-size: 14px; text-align: left;margin-left: 240px; margin-top: -20px;word-spacing: 8px;font-weight: bold;">Fee Paid Rs. </div><div style="margin-left: 350px;margin-top: -20px;"> <?php echo $ex_data['fees'] . '/-'; ?></div>
    </div>
</div>

<div style="font-size: 14px; text-align: left;margin-left: 50px; margin-bottom: 10px;word-spacing: 5px;font-weight: bold;margin-top: 40px;">License is hereby granted to M/s. <div style="margin-left: 270px;margin-top: -18px;"> <?php echo $ex_data['contractor_name']; ?></div></div>
<div style="font-size: 14px; text-align: left;margin-left: 10px; margin-bottom: 10px;word-spacing: 5px;font-weight: bold;margin-top: 10px;">&nbsp;<div style="margin-left: 5px;margin-top: -18px;"> <?php echo $ex_data['contractor_address']; ?></div><div style="font-size: 14px; text-align: left;margin-left: 665px; margin-top: -20px;word-spacing: 5px;font-weight: bold;">Under </div></div>
...
<div style="font-size: 14px; text-align: left;margin-left: 50px; margin-bottom: 10px;word-spacing: 5px;font-weight: bold;margin-top: 40px;">The License shall remain in force till <div style="margin-left: 300px;margin-top: -19px;"> <?php echo $ex_data['duration_of_work']; ?></div></div>
...
<div style="font-size: 14px; text-align: left;margin-left: 10px; margin-bottom: 50px;word-spacing: 8px;margin-top: 20px;font-weight: bold;">Dated<div style="margin-left: 50px;margin-top: -19px;">: <?php echo convert_to_new_date_format($ex_data['status_datetime']); ?></div></div>
<table class="table table-border" style="border-top: 1px solid black; border-bottom: 1px solid black;">
    ...
    <tbody>
        <?php if (!empty($aplicence_data)) { ?>
            <tr>
                <td class="t-a-c"><?php echo convert_to_new_date_format($aplicence_data['date_of_certificate']); ?></td>
                <td class="t-a-c"><?php echo $aplicence_data['fees'] . '/-'; ?></td>
                <td class="t-a-c"><?php echo convert_to_new_date_format($aplicence_data['valid_upto']); ?></td>
                <td class="t-a-c">&nbsp;</td>
            </tr>
        <?php } ?>
        <?php
        foreach ($aplicence_renewal_data as $value) {
            ?>
            <tr>
                <td class="t-a-c"><?php echo convert_to_new_date_format($value['status_datetime']); ?></td>
                <td class="t-a-c"><?php echo $value['fees'] . '/-'; ?></td>
...
<div style="font-size: 14px; text-align: left;margin-left: 10px; margin-bottom: 10px;word-spacing: 8px;margin-top: 20px;font-weight: bold;"> <?php echo $ex_data['establi_name']; ?></div>
<div style="font-size: 14px; text-align: left;margin-left: 10px; margin-bottom: 10px;word-spacing: 8px;margin-top: 20px;font-weight: bold;"> <?php echo $ex_data['establi_address']; ?></div>
...
<div style="font-size: 14px; text-align: left;margin-left: 34px; margin-bottom: 20px;word-spacing: 10px;margin-top: 0px;font-weight: bold;">shall not, on any day, exceed <?php echo $ex_data['max_no_of_empl']; ?> employees. </div>
