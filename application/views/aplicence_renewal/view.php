    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="aplicence_renewal_form" name="aplicence_renewal_form" onsubmit="return false;">
                ...
                <input type="hidden" id="aplicence_renewal_id" name="aplicence_renewal_id" value="{{aplicence_renewal_id}}">
                ...
                <div class="card-body p-b-0px">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter License Number !"
                                       maxlength="100" value="{{registration_number}}" onblur="AplicenceRenewal.listview.getAplicenceData($(this));checkValidation('boiler-act-renewal', 'registration_number', licenseNumberValidationMessage);" readonly >
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_name" name="contractor_name" class="form-control" placeholder="Enter Name of Contractor !"
                                       maxlength="100" readonly onblur="checkValidation('aplicence-renewal', 'contractor_name', contractorNameValidationMessage);" value="{{contractor_name}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="contractor_address" name="contractor_address" class="form-control" placeholder="Enter Address!" maxlength="100" readonly onblur="checkValidation('aplicence-renewal', 'contractor_address', contractorAddressValidationMessage);">{{contractor_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_contact" name="contractor_contact" class="form-control" placeholder="Enter Contact No!"
                                       maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('aplicence-renewal', 'contractor_contact', contractorCcontactValidationMessage);" value="{{contractor_contact}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contractor_email" name="contractor_email" class="form-control" placeholder="Enter Contractor Email !"
                                       maxlength="100" onkeypress="emailIdValidation($(this));" readonly onblur="checkValidationForEmail('aplicence-renewal', 'contractor_email', emailValidationMessage);" value="{{contractor_email}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="no_of_certificate" name="no_of_certificate" class="form-control" placeholder="Enter Number of the Licence !"
                                       maxlength="100" readonly onblur="checkValidation('aplicence-renewal', 'no_of_certificate', certificateNoValidationMessage);" value="{{no_of_certificate}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="date_of_certificate" id="date_of_certificate" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{date_of_certificate}}" readonly onblur="checkValidation('aplicence-renewal', 'date_of_certificate', certificateDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6"><br>
                            ...
                            <div class="input-group date">
                                <input type="text" name="expiry_date_of_prev_licence" id="expiry_date_of_prev_licence" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{expiry_date_of_prev_licence}}" readonly onblur="checkValidation('aplicence-renewal', 'expiry_date_of_prev_licence', expiryDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="max_no_of_empl" name="max_no_of_empl" class="form-control" placeholder="Enter Maximum number of employess !"
                                       maxlength="100"  value="{{max_no_of_empl}}" disabled="">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="licence_status" name="licence_status" class="form-control" placeholder="Enter Licence of the Contractor was suspended or revoked !"
                                       maxlength="100" readonly onblur="checkValidation('aplicence-renewal', 'licence_status', licenceStatusValidationMessage);" value="{{licence_status}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="duration_of_work" name="duration_of_work" class="form-control" placeholder="Enter Duration of Work !"
                                       maxlength="100" disabled="" value="{{duration_of_work}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="establi_name" name="establi_name" class="form-control" placeholder="Enter Name of Applicant !"
                                       maxlength="100" value="{{establi_name}}" disabled="">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="establi_address" name="establi_address" class="form-control" placeholder="Enter Address of Establishment !" maxlength="100" disabled="">{{establi_address}}</textarea>
                            </div>
