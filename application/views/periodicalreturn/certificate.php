<?php
$barcode_number = generate_barcode_number(VALUE_FIFTY, $periodicalreturn_data['periodicalreturn_id']);
...
<table class="CompanyDetails">
    ...
    <tr>
        ...
        <td class="second-column"><?php echo $periodicalreturn_data['location_of_factory']; ?></td>
...
<table style="margin-left: 490px;">
    <tr><td class="border-none"><img src="<?php echo base_url(); ?>documents/periodicalreturn/<?php echo $periodicalreturn_data['mw_sign_of_principal_employer']; ?>" height="60px" width="90px"></td></tr>
</table>
