    ...
    <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
                <h3 class="card-title" style="float: none; text-align: center;">Periodical Return Form</h3>
                <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;">Application of Periodical Return </div>
            </div>
            <form role="form" id="periodicalreturn_form" name="periodicalreturn_form" onsubmit="return false;">

                <input type="hidden" id="periodicalreturn_id" name="periodicalreturn_id" value="{{periodicalreturn_data.periodicalreturn_id}}">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <span class="error-message error-message-periodicalreturn f-w-b" style="border-bottom: 2px solid red;"></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                    data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('periodicalreturn', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);">
                            </select>
                            </div>
                            ...
                            <label>2. Select type of Application<span class="color-nic-red">*</span></label>
                             <div class="input-group">
                                <select class="form-control select2" id="application_category" name="application_category"  onchange="Periodicalreturn.listview.getApplicanttype(this);"
                                        data-placeholder="Type Of Application !"    >
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_applicant" name="name_of_applicant" class="form-control" placeholder="Enter Name of Applicant !" 
                                       maxlength="100"  value="{{periodicalreturn_data.name_of_applicant}}" onblur="checkValidation('periodicalreturn', 'name_of_applicant', applicationCategoryValidationMessage);">
                            </div>
                         ...
                         <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="applicant_address" name="applicant_address" class="form-control" placeholder="Enter Address of the Applicant !" 
                                       maxlength="100"  value="{{periodicalreturn_data.applicant_address}}" onblur="checkValidation('periodicalreturn', 'applicant_address', applicantAddressValidationMessage);">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="applicant_licence_no" name="applicant_licence_no" class="form-control" placeholder="Enter Licence No !" 
                                       maxlength="100"  value="{{periodicalreturn_data.applicant_licence_no}}" onblur="checkValidation('periodicalreturn', 'applicant_licence_no', licenseNumberValidationMessage);">
                            </div>
                    ...
                    <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="applicant_licence_date" id="applicant_licence_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{applicant_licence_date}}" onblur="checkValidation('periodicalreturn', 'applicant_licence_date', appDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="description_wm" name="description_wm" class="form-control" placeholder="Enter Description of the Weight or Measure !" 
                                       maxlength="100"  value="{{periodicalreturn_data.description_wm}}">
                            </div>
                         ...
                         <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="period_validity_licence" name="period_validity_licence" class="form-control" placeholder="Enter Period of Validity of licence !" 
                                       maxlength="100"  value="{{periodicalreturn_data.period_validity_licence}}" >
                            </div>
 ...
 -->
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="suspending_revoke" name="suspending_revoke" class="form-control" placeholder="Enter Revoking the Licence !" 
                                       maxlength="100"  value="{{periodicalreturn_data.suspending_revoke}}" >
                            </div>
            ...
            <div class="row applicant_ld_div" style="display: none">                    
                         <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="category_of_wm" name="category_of_wm" class="form-control" placeholder="Enter Category of Weight or Measure !" 
                                       maxlength="100"  value="{{periodicalreturn_data.category_of_wm}}" >
                            </div>
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_repairer" onclick="Periodicalreturn.listview.addMultipleRepairer({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                </div>           
                ...
                <div class="col-xs-12 applicant_ld_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product" onclick="Periodicalreturn.listview.addMultipleProprietor({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="col-xs-12 applicant_ld_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_detail" onclick="Periodicalreturn.listview.addOther({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                </div>
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_manufacturer" onclick="Periodicalreturn.listview.addMultipleManufacturer({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                    </div>
                    <br/>
                ...
                <div class="col-xs-12 applicant_lm_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product_manufacturertwo" onclick="Periodicalreturn.listview.addMultipleManufacturertwo({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Details
                            </button>
                        </div>
                    </div>
