    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="ismw_form" name="ismw_form" onsubmit="return false;">
                ...
                <input type="hidden" id="ismw_id" name="ismw_id" value="{{ismw_data.ismw_id}}">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name" name="name" class="form-control" placeholder="Name !" maxlength="100" value="{{ismw_data.name}}" 
                                       onblur="checkValidation('ismw', 'name', personNameValidationMessage);">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date ">
                                <input type="text" name="dob" id="dob" class="form-control date_picker" placeholder="DD-MM-YYYY" data-date-format="DD-MM-YYYY"
                                       value="{{dob}}" onblur="checkValidation('ismw', 'dob', dateValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div id="gender_container_for_ismw">
                            </div>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" id="mobile_no" name="mobile_no" class="form-control" placeholder=" Mobile No. !"
                                   maxlength="10" onblur="checkNumeric($(this)); checkValidationForMobileNumber('ismw', 'mobile_no', mobileValidationMessage);" value="{{ismw_data.mobile_no}}">
                            <span class="error-message error-message-ismw-mobile_no"></span>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>6. Aadhaar No. <span style="color: red;">*</span></label>
                            <input type="text" id="aadhaar_no" name="aadhaar_no" class="form-control" placeholder=" Aadhaar No. !"
                                   maxlength="12" onblur="checkNumeric($(this)); checkValidation('ismw', 'aadhaar_no', aadharnoValidationMessage);" value="{{ismw_data.aadhaar_no}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="state_for_ismw" name="state_for_ismw" class="form-control select2"
                                        data-placeholder="Select Native State/UT"
                                        onchange="checkValidation('ismw', 'state_for_ismw', stateValidationMessage);
                                            ISMW.listview.getDistrictData($(this), 'ismw'); $('#other_village_name_container_for_ismw').hide();">
                                </select>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="district_for_ismw" name="district_for_ismw" class="form-control select2"
                                        data-placeholder="Select Native District"
                                        onchange="checkValidation('ismw', 'district_for_ismw', districtValidationMessage);
                                            ISMW.listview.getVillageData($(this), 'ismw'); $('#other_village_name_container_for_ismw').hide();">
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="p_block_no" name="p_block_no" class="form-control" placeholder="Block/Ward No. !" maxlength="100" value="{{ismw_data.p_block_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="village_for_ismw" name="village_for_ismw" class="form-control select2"
                                        data-placeholder="Select Native Village"
                                        onchange="ISMW.listview.villageChangeEvent($(this));">
                                </select>
                            </div>
                            <span class="error-message error-message-ismw-village_for_ismw"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="p_house_no" name="p_house_no" class="form-control" placeholder="House No. !" maxlength="100" value="{{ismw_data.p_house_no}}">
                            </div>
                            <span class="error-message error-message-ismw-p_house_no"></span>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>12. Pincode <span style="color: red;">*</span></label>
                            <input type="text" id="p_pincode" name="p_pincode" class="form-control" placeholder="Pincode !"
                                   maxlength="12" onblur="checkNumeric($(this)); checkValidation('ismw', 'p_pincode', pincodeValidationMessage);" value="{{ismw_data.p_pincode}}">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="ee_state" name="ee_state" class="form-control select2"
                                        data-placeholder="Select Native State/UT"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select id="ee_dist" name="ee_dist" class="form-control select2"
                                        data-placeholder="Select Native District"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="ee_occuption" name="ee_occuption" class="form-control" placeholder="Occupation !" maxlength="100" value="{{ismw_data.ee_occuption}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="ee_nature" name="ee_nature" class="form-control" placeholder="Nature of employment (perm/remp/casual/contract/daily) !" maxlength="100" value="{{ismw_data.ee_nature}}">
                            </div>
