            ...
            <form role="form" id="landallotment_form" name="landallotment_form" onsubmit="return false;">
                ...
                <div class="row">
                    ...
                    <div class="form-group"><!-- 
                        ...
                        <button type="button" id="submit_btn_for_landallotment" class="btn btn-sm btn-success" onclick="Landallotment.listview.submitLandallotment({{VALUE_TWO}});" style="margin-right: 5px;">Submit</button>
