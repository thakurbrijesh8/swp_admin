<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="$('#generate_excel_for_landallotment').submit();">
            <i class="fas fa-file-excel" style="margin-right: 2px;"></i>&nbsp; Download Excel</button>
    </div>
    <div class="card-body" id="landallotment_datatable_container">
        <div class="table-responsive">
            <table id="landallotment_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if (is_admin() || is_view_all_district_user()) { ?>
                                <select id="district_for_landallotment_list" class="form-control"
                        ...
                        <th>
                            <select id="entity_establishment_type_for_landallotment_list" class="form-control"
                        ...
                        <th>
                            <select id="app_timing_for_landallotment_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="status_for_landallotment_list" class="form-control"
                                    data-placeholder="Status !">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="query_status_for_landallotment_list" class="form-control"
