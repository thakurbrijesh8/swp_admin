                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_delaer" class="btn btn-sm btn-success" onclick="DealerRenewal.listview.submitDealerRenewal({{VALUE_ONE}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
