    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="dealer_renewal_form" name="dealer_renewal_form" onsubmit="return false;">
                <input type="hidden" id="dealer_renewal_id" name="dealer_renewal_id" value="{{dealer_renewal_id}}">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="admin_registration_number" name="admin_registration_number" class="form-control" placeholder="Enter Dealer's License Number !"
                                       maxlength="100" value="{{admin_registration_number}}" readonly onblur="DealerRenewal.listview.getDealerData($(this))">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_dealer" name="name_of_dealer" class="form-control" placeholder="Enter Name of the establishment/shop/person seeking the license !"
                                       maxlength="100" readonly onblur="checkValidation('dealer', 'name_of_dealer', dealerNameValidationMessage);" value="{{name_of_dealer}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="complete_address" name="complete_address" class="form-control" placeholder="Enter Complete address of the establishment !" maxlength="100" readonly onblur="checkValidation('dealer', 'complete_address', workshopAddressValidationMessage);">{{complete_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="establishment_date" id="establishment_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{establishment_date}}" readonly onblur="checkValidation('dealer', 'establishment_date', establishmentDateValidationMessage);">
                    ...
                    <div class="col-xs-12 proprietor_info_div" style="display: none">
                        ...
                        <div class="box-footer" align="right" >
                            <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_principle_product" onclick="DealerRenewal.listview.addMultipleProprietor({});" style="margin-right: 5px;margin-top: 5px;" disabled><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Proprietor
                            </button>
                        </div>
                    </div><br/><br/>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="registration_date" id="registration_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{registration_date}}" readonly onblur="checkValidation('dealer', 'registration_date', shopDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Registration Number of shop/establishment/Municipal Trade License !"
                                       maxlength="100" readonly onblur="checkValidation('dealer', 'registration_number', shopRegNoValidationMessage);" value="{{registration_number}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="categories_sold" name="categories_sold" class="form-control" placeholder="Enter Categories of weights and measures sold/proposed to be sold at present !" maxlength="100" readonly onblur="checkValidation('dealer', 'categories_sold', categoriesSoldValidationMessage);">{{categories_sold}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" style="margin-top: 22px;" 
                                    data-placeholder="Status !" name="identity_choice" id="identity_choice" readonly onblur="checkValidation('dealer', 'identity_choice', identityChoiceValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="identity_number" name="identity_number" class="form-control" placeholder="Enter Vat/Sales Tax Registration Numbers/CST Number/Professional Tax registration Number/It Number !"
                                       maxlength="100" readonly onblur="checkValidation('dealer', 'identity_number', identityNoValidationMessage);" value="{{identity_number}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_of_importer" name="registration_of_importer" class="form-control" placeholder="Enter Registration of importer of Weights and Measures, if any !"
                                       maxlength="100" readonly onblur="checkValidation('dealer', 'registration_of_importer', importerRegValidationMessage);" value="{{registration_of_importer}}">
                            </div>
                            <span class="error-message error-message-dealer-registration_of_importer"></span>
                        </div>
                        <input type="hidden" id="import_model" name="import_model" value="{{import_model}}">
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">18. &nbsp;
                                    <input type="checkbox" class="" name="declarationtwo" id="declarationtwo" autocomplete="true" value="{{is_checked}}" disabled onblur="checkValidation('dealer', 'declarationtwo', declarationTwoValidationMessage);">&nbsp;I/We agree to deposit the Scheduled license fees with Government as soon as required to do so by the Licensing Authority.
                                    <span style="color: red;">*</span>
                                </span>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            <div class="input-group">
                                <span class="input-group-addon">19. &nbsp;
                                    <input type="checkbox" class="" name="declarationthree" id="declarationthree" autocomplete="true" value="{{is_checked}}" disabled onblur="checkValidation('dealer', 'declarationthree', declarationThreeValidationMessage);">&nbsp;All the information furnished above is true to the best of my/our knowledge.
                                    <span style="color: red;">*</span>
                                </span>
                            </div>
