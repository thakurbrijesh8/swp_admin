                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="enterprise_name" name="enterprise_name" class="form-control" placeholder="Enter Name of the Enterprise !"
                                       maxlength="100" readonly onblur="checkValidation('incentive-partf', 'enterprise_name', enterpriseNameValidationMessage);" value="{{enterprise_name}}">
                            </div>
                    ...
                    <div class="row new_project_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="investment" name="investment" class="form-control" placeholder="Enter Investment made in Plant & Machinery  - (In Lacs) !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partf', 'investment', investmentValidationMessage);" value="{{investment}}">
                            </div>
                    ...
                    <div class="row expansion_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="machinery_units" name="machinery_units" class="form-control" placeholder="Enter Investment already made in Plant & Machinery in Existing Unit !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partf', 'machinery_units', machineryUnitValidationMessage);" value="{{machinery_units}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="new_investment" name="new_investment" class="form-control" placeholder="Enter New Investment in Plant & Machinery !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partf', 'new_investment', newInvestmentValidationMessage);" value="{{new_investment}}">
                            </div>
                    ...
                    <div class="row expansion_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="investment_percentage" name="investment_percentage" class="form-control" placeholder="Enter Increase in Investment (%) !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partf', 'investment_percentage', investmentPercentageValidationMessage);" value="{{investment_percentage}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="term_loan_date" id="term_loan_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{term_loan_date}}" readonly onblur="checkValidation('incentive-partf', 'term_loan_date', termLoanDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="loan_accountno" name="loan_accountno" class="form-control" placeholder="Enter Term Loan Account No. !" maxlength="100" readonly onblur="checkValidation('incentive-partf', 'loan_accountno', loanAccountNoValidationMessage);" value="{{loan_accountno}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="interest_subsidy" name="interest_subsidy" class="form-control" placeholder="Enter Interest Subsidy @ 5% (max. 50 Lakhs) per annum !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partf', 'interest_subsidy', intrestSubsidyValidationMessage);" value="{{interest_subsidy}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="other_info" name="other_info" class="form-control" placeholder="Enter Any Other Information !"
                                       maxlength="100" readonly onblur="checkValidation('incentive-partf', 'other_info', otherInfoValidationMessage);" value="{{other_info}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partf_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.editOrViewFormsForView($('#previous_btn_for_partf_details'), '{{incentive_id}}', false, 'partf_form');" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_incentive_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.editOrViewScheme($('#previous_btn_for_partf_details'), '{{incentive_id}}', true);" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
