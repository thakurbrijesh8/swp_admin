                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_seal_container_for_textile">
                            ...
                            <div class="error-message error-message-textile-sign_seal_for_textile"></div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_declaration_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.submitTextileDeclaration({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
