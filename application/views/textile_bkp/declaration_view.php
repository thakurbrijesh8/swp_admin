        ...
        <div class="card">
            ...
            <form role="form" id="declaration_form" name="declaration_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_seal_container_for_textile">
                            <label>Upload Authorized Signatory Designation with Seal<span style="color: red;">* (Maximum File Size: 1MB)</span></label><br>
                            <input type="file" id="sign_seal_for_textile" name="sign_seal_for_textile"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif">
                            <div class="error-message error-message-msme-sign_seal_for_textile"></div>
                        </div>
                        <div class="form-group col-sm-12" id="sign_seal_name_container_for_textile" style="display: none;">
                            <label>Authorized Signatory Designation with Seal <span style="color: red;">*</label><br>
                            <img id="sign_seal_name_image_for_textile" style="width: 250px; height: 250px; border: 2px solid blue;">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="button" class="btn btn-sm btn-danger" onclick="Textile.listview.loadTextileData();">Cancel</button>
                        <button type="button" id="submit_btn_for_declaration_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.editOrViewChecklist($('#previous_btn_for_checklist_details'), '{{incentive_id}}', false);" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
                        <button type="button" id="previous_btn_for_incentive_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.editOrViewForms($('#previous_btn_for_parte_details'), '{{incentive_id}}', true, 'declaration_form');" style="margin-right: 5px;"><span class="fas fa-hand-point-left"></span> Previous</button>
                    </div>
                </div>
            </form>
        </div>
