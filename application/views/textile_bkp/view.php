                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="enterprise_name" name="enterprise_name" class="form-control" placeholder="Enter Name of the Enterprise !"
                                       maxlength="100" readonly onblur="checkValidation('textile', 'enterprise_name', enterpriseNameValidationMessage);" value="{{enterprise_name}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="office_address" name="office_address" class="form-control" placeholder="Enter Office Address with pin code No. !" maxlength="100" readonly onblur="checkValidation('textile', 'office_address', officeAddressValidationMessage);">{{office_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="factory_address" name="factory_address" class="form-control" placeholder="Enter Factory Address with pin code No. !" maxlength="100" readonly onblur="checkValidation('textile', 'factory_address', factoryAddressValidationMessage);">{{factory_address}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="office_contactno" name="office_contactno" class="form-control" placeholder="Enter Office Contact No. !" onkeyup="checkNumeric($(this));" maxlength="100" readonly onblur="checkValidation('textile', 'office_contactno', officeContactNoValidationMessage);" value="{{office_contactno}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="factory_contactno" name="factory_contactno" class="form-control" placeholder="Enter Factory Contact No. !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('textile', 'factory_contactno', factoryContactNoValidationMessage);" value="{{factory_contactno}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label>2.4 Fax </label>
                            <div class="input-group">
                                <input type="text" id="fax" name="fax" class="form-control" placeholder="Enter Fax !" maxlength="100" readonly onblur="checkValidation('textile', 'fax', faxValidationMessage);" value="{{fax}}" onkeyup="checkNumeric($(this));">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="cellphone" name="cellphone" class="form-control" placeholder="Enter Cell Phone !" maxlength="100" readonly onblur="checkValidationForMobileNumber('textile', 'cellphone', cellPhnoValidationMessage);" value="{{cellphone}}" onkeyup="checkNumeric($(this));">
                            </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" placeholder="Enter Email !" maxlength="100" readonly onblur="checkValidationForEmail('textile', 'email', emailValidationMessage);" value="{{email}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="promoters_details" name="promoters_details" class="form-control" placeholder="Enter Name,Designation & Contact Details of the Promoter !" maxlength="100" readonly onblur="checkValidation('textile', 'promoters_details', promotersDetailValidationMessage);">{{promoters_details}}</textarea>
                            </div>
                    ...
                    <div class="row proprietor_share_div" style="display: none;">
                        <div class="form-group col-sm-12">  
                            ...
                            <div class="box-footer" align="right" >
                                <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_proprietor_share" onclick="Textile.listview.addProprietorShare({});" style="margin-right: 5px;margin-top: 5px;" disabled><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Proprietor share
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="othorized_person_detail" name="othorized_person_detail" class="form-control" placeholder="Enter Name,Designation & Contact Details of the Authorized Person !" maxlength="100" readonly onblur="checkValidation('textile', 'othorized_person_detail', othorizedPersonDetailValidationMessage);">{{othorized_person_detail}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="emno_part1" name="emno_part1" class="form-control" placeholder="Enter Part i E.M. No. !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('textile', 'emno_part1', emNoValidationMessage);" value="{{emno_part1}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="emdate_part1" id="emdate_part1" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{emdate_part1}}" readonly onblur="checkValidation('textile', 'emdate_part1', emDateValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="emno_part2" name="emno_part2" class="form-control" placeholder="Enter Part ii E.M. No. !" maxlength="100" readonly onblur="checkValidation('textile', 'emno_part2', emNoValidationMessage);" value="{{emno_part2}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="emdate_part2" id="emdate_part2" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{emdate_part2}}" readonly onblur="checkValidation('textile', 'emdate_part2', emDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="manufacturing_items" name="manufacturing_items" class="form-control" placeholder="Enter Manufacturing items!" maxlength="100" readonly onblur="checkValidation('textile', 'manufacturing_items', manufacturingItemValidationMessage);">{{manufacturing_items}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_capacity" name="annual_capacity" class="form-control" placeholder="Enter annual production capacity !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('textile', 'annual_capacity', annualCapacityValidationMessage);" value="{{annual_capacity}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="approval_no" name="approval_no" class="form-control" placeholder="Enter Approval / Consent No. !" maxlength="100" readonly onblur="checkValidation('textile', 'approval_no', approvalNoValidationMessage);" value="{{approval_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="pccno_date" id="pccno_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{pccno_date}}" readonly onblur="checkValidation('textile', 'pccno_date', pccDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="pccno_validupto_date" id="pccno_validupto_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{pccno_validupto_date}}" readonly onblur="checkValidation('textile', 'pccno_validupto_date', pccValidUptoDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="factory_registration_no" name="factory_registration_no" class="form-control" placeholder="Enter Registration No. !" maxlength="100" readonly onblur="checkValidation('textile', 'factory_registration_no', factoryNoValidationMessage);" value="{{factory_registration_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="establishment_date" id="establishment_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{establishment_date}}" readonly onblur="checkValidation('textile', 'establishment_date', establishmentsDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="establishment_validupto_date" id="establishment_validupto_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{establishment_validupto_date}}" readonly onblur="checkValidation('textile', 'establishment_validupto_date', establishmentValidUptoDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="commencement_date" id="commencement_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{commencement_date}}" readonly onblur="checkValidation('textile', 'commencement_date', commencementDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_turnover" name="annual_turnover" class="form-control" placeholder="Enter Annual Turnover of the Year {{previousYear}}" maxlength="100" readonly onblur="checkValidation('textile', 'annual_turnover', turnoverValidationMessage);" value="{{annual_turnover}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_turnover_one" name="annual_turnover_one" class="form-control" placeholder="Enter Annual Turnover of the Year {{previousYearOne}}" maxlength="100" readonly onblur="checkValidation('textile', 'annual_turnover_one', turnoverValidationMessage);" value="{{annual_turnover_one}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_turnover_two" name="annual_turnover_two" class="form-control" placeholder="Enter Annual Turnover of the Year {{previousYearTwo}}" maxlength="100" readonly onblur="checkValidation('textile', 'annual_turnover_two', turnoverValidationMessage);" value="{{annual_turnover_two}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_turnover_three" name="annual_turnover_three" class="form-control" placeholder="Enter Annual Turnover of the Year {{previousYearThree}}" maxlength="100" readonly onblur="checkValidation('textile', 'annual_turnover_three', turnoverValidationMessage);" value="{{annual_turnover_three}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="annual_turnover_four" name="annual_turnover_four" class="form-control" placeholder="Enter Annual Turnover of the Year {{previousYearFour}}" maxlength="100" readonly onblur="checkValidation('textile', 'annual_turnover_four', turnoverValidationMessage);" value="{{annual_turnover_four}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="bank_name" name="bank_name" class="form-control" placeholder="Enter Name of Bank !" maxlength="100" readonly onblur="checkValidation('textile', 'bank_name', nameOfBankValidationMessage);" value="{{bank_name}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="account_no" name="account_no" class="form-control" placeholder="Enter Bank Account No !" maxlength="100" readonly onblur="checkValidation('textile', 'account_no', bankAccountNoValidationMessage);" value="{{account_no}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="ifsc_no" name="ifsc_no" class="form-control" placeholder="Enter IFSC Code No. !" maxlength="100" readonly onblur="checkValidation('textile', 'ifsc_no', ifscCodeValidationMessage);" value="{{ifsc_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="bankbranch_no" name="bankbranch_no" class="form-control" placeholder="Enter Branch Code No !" maxlength="100" readonly onblur="checkValidation('textile', 'bankbranch_no', branchCodeValidationMessage);" value="{{bankbranch_no}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="pancard_no" name="pancard_no" class="form-control" placeholder="Enter PAN Card No. of the Unit !" maxlength="100" readonly onblur="checkValidation('textile', 'pancard_no', panCardValidationMessage);" value="{{pancard_no}}">
                            </div>
