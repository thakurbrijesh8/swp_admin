                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="partf_form" name="partf_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(F) INTEREST SUBSIDY FOR TEXTILE SECTOR
                            <span class="error-message error-message-scheme-partf_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="partg_form" name="partg_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(G) INTEREST SUBSIDY IN TECHNICAL TEXTILE
                            <span class="error-message error-message-scheme-partg_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="parth_form" name="parth_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(H) ASSISTANCE FOR TECHNOLOGY UPGRADATION
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_scheme_details" class="btn btn-sm btn-success pull-right"  onclick="Textile.listview.editOrViewFormsForView($('#previous_btn_for_scheme_details'), '{{incentive_id}}', false, 'scheme_form');" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
