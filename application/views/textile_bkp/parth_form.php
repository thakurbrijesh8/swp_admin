                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="enterprise_name" name="enterprise_name" class="form-control" placeholder="Enter Name of the Enterprise !"
                                       maxlength="100" onblur="checkValidation('incentive-parth', 'enterprise_name', enterpriseNameValidationMessage);" value="{{enterprise_name}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="acquisition" name="technology_purpose" class="" value="{{VALUE_ONE}}" >&nbsp; Acquisition
                                &emsp;
                                <input type="radio" id="upgradation" name="technology_purpose" class="" style="margin-bottom: 0px;" value="{{VALUE_TWO}}" >&nbsp;Upgradation
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="sector_textile" name="sector_textile" class="form-control" placeholder="Enter Sector of Technical Textile (from 13 sector as in Scheme) !"
                                       maxlength="100" onblur="checkValidation('incentive-parth', 'sector_textile', sectorTextileValidationMessage);" value="{{sector_textile}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="radio" id="enterprise_accqu_yes" name="enterprise_accqu" class="" value="{{VALUE_ONE}}" >&nbsp; YES
                                &emsp;
                                <input type="radio" id="enterprise_accqu_no" name="enterprise_accqu" class="" style="margin-bottom: 0px;" value="{{VALUE_TWO}}" >&nbsp;NO
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="justification" name="justification" class="form-control" placeholder="Enter Give Details with Justification !"
                                           maxlength="100" onblur="checkValidation('incentive-parth', 'justification', justificationValidationMessage);" value="{{justification}}">
                                </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="process_detail" name="process_detail" class="form-control" placeholder="Enter Brief of New Technology with manufacturing process & details thereof !"
                                           maxlength="100" onblur="checkValidation('incentive-parth', 'process_detail', processDetailValidationMessage);" value="{{process_detail}}">
                                </div>
                                <span class="error-message error-message-incentive-parth-justification"></span>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="name_address" name="name_address" class="form-control" placeholder="Enter Name & Address of the entity from which Technology will be acquired along with copy of !"
                                           maxlength="100" onblur="checkValidation('incentive-parth', 'name_address', nameAddressValidationMessage);" value="{{name_address}}">
                                </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="commencement_date" id="commencement_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{commencement_date}}" onblur="checkValidation('incentive-parth', 'commencement_date', commencementDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        <th>
                                            <input type="text" id="purchase" name="purchase" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalAcquisition($(this));checkValidation('incentive-parth', 'purchase', purchaseValidationMessage);" value="{{purchase}}">
                                            <span class="error-message error-message-incentive-parth-purchase"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="technology_fees" name="technology_fees" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalAcquisition($(this));checkValidation('incentive-parth', 'technology_fees', technologyFeesValidationMessage);" value="{{technology_fees}}">
                                            <span class="error-message error-message-incentive-parth-technology_fees"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="other_detail" name="other_detail" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalAcquisition($(this));checkValidation('incentive-parth', 'other_detail', otherDetailValidationMessage);" value="{{other_detail}}">
                                            <span class="error-message error-message-incentive-parth-other_detail"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="upgradation_total" name="upgradation_total" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('incentive-parth', 'upgradation_total', financeTotalValidationMessage);" value="{{upgradation_total}}" readonly>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        <th>
                                            <input type="text" id="contribution" name="contribution" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotal($(this));checkValidation('incentive-parth', 'contribution', contributionValidationMessage);" value="{{contribution}}">
                                            <span class="error-message error-message-incentive-parth-contribution"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="term_loan" name="term_loan" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotal($(this));checkValidation('incentive-parth', 'term_loan', termLoanValidationMessage);" value="{{term_loan}}">
                                            <span class="error-message error-message-incentive-parth-term_loan"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="unsecured_loan" name="unsecured_loan" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotal($(this));checkValidation('incentive-parth', 'unsecured_loan', unsecuredLoanValidationMessage);" value="{{unsecured_loan}}">
                                            <span class="error-message error-message-incentive-parth-unsecured_loan"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="accruals" name="accruals" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotal($(this));checkValidation('incentive-parth', 'accruals', accrualsValidationMessage);" value="{{accruals}}">
                                            <span class="error-message error-message-incentive-parth-accruals"></span>
                                        </th>
                                        <th>
                                            <input type="text" id="finance_total" name="finance_total" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('incentive-parth', 'finance_total', financeTotalValidationMessage);" value="{{finance_total}}" readonly>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="term_loan_date" id="term_loan_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{term_loan_date}}" onblur="checkValidation('incentive-parth', 'term_loan_date', termLoanDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="loan_accountno" name="loan_accountno" class="form-control" placeholder="Enter Term Loan Account No. !" maxlength="100" onblur="checkValidation('incentive-parth', 'loan_accountno', loanAccountNoValidationMessage);" value="{{loan_accountno}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="interest_subsidy" name="interest_subsidy" class="form-control" placeholder="Enter [25% (max.25 Lakhs) once during the operative period] !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parth', 'interest_subsidy', intrestSubsidyValidationMessage);" value="{{interest_subsidy}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="other_info" name="other_info" class="form-control" placeholder="Enter Any Other Information !"
                                       maxlength="100" onblur="checkValidation('incentive-parth', 'other_info', otherInfoValidationMessage);" value="{{other_info}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_parth_details" class="btn btn-sm btn-success pull-right" onclick="Textile.listview.submitPartHDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
