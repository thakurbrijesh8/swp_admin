...
<div>
    ...
    <div class="timeline-item">
        <span class="time color-nic-black"><i class="fas fa-clock"></i> Query Response Date Time : <span class="color-nic-red">{{datetime_text}}</span></span>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody id="document_item_container_for_query_answer_view_{{cnt}}"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
