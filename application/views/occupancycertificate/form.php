    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title" style="float: none; text-align: center;">Form of Completion Certificate1111</h3>
            </div>
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="completed_on" id="completed_on" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{completed_on}}" onblur="checkValidation('occupancycertificate', 'completed_on', completionOnDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="licensed_engineer_name" name="licensed_engineer_name" class="form-control" placeholder="Enter Name of the Licensed Architect / Engineer / Surveyor / Structural Engineer  !"
                                       maxlength="100" onblur="checkValidation('occupancycertificate', 'licensed_engineer_name', licensedEngineerNameValidationMessage);" value="{{occupancycertificate_data.licensed_engineer_name}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="occupancy_valid_upto" id="occupancy_valid_upto" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{occupancy_valid_upto}}" onblur="checkValidation('occupancycertificate', 'occupancy_valid_upto', occupancyValidUptoValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="address" name="address" class="form-control" placeholder="Enter If Any Defense Installations Are Involved  !" maxlength="100" onblur="checkValidation('occupancycertificate', 'address', occupancyAddressValidationMessage);">{{occupancycertificate_data.address}}</textarea>
                            </div>
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 m-b-5px" id="form_of_indemnity_container_for_occupancycertificate">
                            <label>18.1 Form of Indemnity On Stamp paper of Rs. 20/- (if application is for Part Occupancy).<a href="documents/departments/PDA/Annexure - 16.pdf" download>(Download Formate of  Annexure -16)</a></label>
                            <label class="f-w-n">Document Not Uploaded</label><br>
