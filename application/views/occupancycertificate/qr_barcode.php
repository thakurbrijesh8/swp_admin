<?php
$barcode_number = generate_barcode_number(VALUE_TWENTYEIGHT, $occupancycertificate_data['occupancy_certificate_id']);

$header_array = array();
$header_array['title'] = 'Certificate';
$header_array['department_name'] = 'Department of PDA';
$header_array['district'] = $occupancycertificate_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Daman and Diu';
