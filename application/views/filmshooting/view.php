    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="filmshooting_form" name="filmshooting_form" onsubmit="return false;">
                ...
                <input type="hidden" id="filmshooting_id" name="filmshooting_id" value="{{filmshooting_id}}">
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="production_house" name="production_house" class="form-control" placeholder="Enter Production House/Company/Producer :  !"
                                       maxlength="100" readonly onblur="checkValidation('filmshooting', 'production_house', productionHouseValidationMessage);" value="{{production_house}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="address" name="address" class="form-control" placeholder="Enter Permanent Address !" maxlength="100" readonly onblur="checkValidation('filmshooting', 'address', permanentAddressValidationMessage);">{{address }}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="production_manager" name="production_manager" class="form-control" placeholder="Enter Production Manager  !"
                                       maxlength="100" readonly onblur="checkValidation('filmshooting', 'production_manager', productionManagerValidationMessage);" value="{{production_manager}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="contact_no" name="contact_no" class="form-control" placeholder="Enter Contact No's/Facsimile  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('filmshooting', 'contact_no', contactNoValidationMessage);" value="{{contact_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" placeholder="Enter E-Mail  !"
                                       maxlength="100" readonly onblur="checkValidationForEmail('filmshooting', 'email', emailValidationMessage);" value="{{email}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="director_cast" name="director_cast" class="form-control" placeholder="Enter Director/Cast  !"
                                       maxlength="100" readonly onblur="checkValidation('filmshooting', 'director_cast', directorValidationMessage);" value="{{director_cast}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="film_title" name="film_title" class="form-control" placeholder="Enter Film Title  !"
                                       maxlength="100" readonly onblur="checkValidation('filmshooting', 'film_title', filmTitleValidationMessage);" value="{{film_title}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="film_synopsis" name="film_synopsis" class="form-control" placeholder="Enter Film Synopsis Mandatory (In 100 Words)  !" maxlength="100" readonly onblur="checkValidation('filmshooting', 'film_synopsis', filmSynopsisValidationMessage);">{{film_synopsis}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="film_shooting_days" name="film_shooting_days" class="form-control" placeholder="Enter Number Of Film Shooting Days In Goa  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('filmshooting', 'film_shooting_days', filmShootingDaysValidationMessage);" value="{{film_shooting_days}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="shooting_location" name="shooting_location" class="form-control" placeholder="Enter Film Shooting Locations  !"
                                       maxlength="100" readonly onblur="checkValidation('filmshooting', 'shooting_location', shootingLocationValidationMessage);" value="{{shooting_location}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="shooting_date_time" id="shooting_date_time" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{shooting_date_time}}" readonly onblur="checkValidation('filmshooting', 'shooting_date_time', shootingDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="defense_installation" name="defense_installation" class="form-control" placeholder="Enter If Any Defense Installations Are Involved  !" maxlength="100" readonly onblur="checkValidation('filmshooting', 'defense_installation', defenseInstallationValidationMessage);">{{defense_installation}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="declaration_name_container_for_filmshooting" style="display: none;">
                            <label>13 .Negative Portrayal Of The U.T. of Dadra and Nagar Haveli & Daman and Diu in Any Manner Is Not Permitted And Will Not Be Allowed. Therefore The Producer/ Production Company May Submit A Declaration To This Effect<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload PDF Only)</span></label><br>
                            <a target="_blank" id="declaration_name_image_for_filmshooting_download"><label id="declaration_name_image_for_filmshooting" class="btn-nic-blue f-w-n" style="border: 2px solid black;padding: 4px 4px 4px 4px;">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="producer_signature_name_container_for_filmshooting" style="display: none;">
                            <label>14. Signed By The Producer (Of The Film)<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                             <a target="_blank" id="producer_signature_download">
                            <img id="producer_signature_name_image_for_filmshooting" style="width: 250px;
                             height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="authorized_representative_sign_name_container_for_filmshooting" style="display: none;">
                            <label>15. Signature Of Authorized Representative<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <a target="_blank" id="authorized_representative_sign_download"><img id="authorized_representative_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="seal_of_company_name_container_for_filmshooting" style="display: none;">
                            <label>16. Seal Of Company<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <a target="_blank" id="seal_of_company_download"> <img id="seal_of_company_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" id="undersigned" name="undersigned" class="form-control" placeholder="Enter I the undersigned  !"
                                       maxlength="100" onblur="checkValidation('filmshooting', 'undersigned', undersignedValidationMessage);" value="{{undersigned}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" id="aged" name="aged" class="form-control" placeholder="Enter aged  !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('filmshooting', 'aged', agedYearValidationMessage);" value="{{aged}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group">
                                <input type="text" id="resident" name="resident" class="form-control" placeholder="Enter resident of District Daman  !"
                                       maxlength="100" onblur="checkValidation('filmshooting', 'resident', residentValidationMessage);" value="{{resident}}" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="input-group">
                                <textarea id="purpose" name="purpose" class="form-control" placeholder="Enter Purpose  !"
                                       maxlength="100" onblur="checkValidation('filmshooting', 'purpose', purposeValidationMessage);" readonly >{{purpose}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="witness_one_name" name="witness_one_name" class="form-control" placeholder="Enter Witness-1 Name  !"
                                       maxlength="100" onblur="checkValidation('filmshooting', 'witness_one_name', witnessNameValidationMessage);" value="{{witness_one_name}}" readonly>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="witness_one_sign_name_container_for_filmshooting" style="display: none;">
                            <label>Witness-1 Signature<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                             <a target="_blank" id="witness_one_sign_download"><img id="witness_one_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="witness_two_name" name="witness_two_name" class="form-control" placeholder="Enter Witness-1 Name  !"
                                       maxlength="100" onblur="checkValidation('filmshooting', 'witness_two_name', witnessNameValidationMessage);" value="{{witness_two_name}}" readonly>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="witness_two_sign_name_container_for_filmshooting" style="display: none;">
                            <label>witness-2 Signature<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                            <a target="_blank" id="witness_two_sign_download"><img id="witness_two_sign_name_image_for_filmshooting" style="width: 250px; height: 250px; border: 2px solid blue;"></a>
