<div class="card">
    <div class="card-header">
        ...
        <button type="button" class="btn btn-sm btn-success pull-right" style="padding: 2px 7px;"
                onclick="$('#generate_excel_for_filmshooting').submit();">
            <i class="fas fa-file-excel" style="margin-right: 2px;"></i>&nbsp; Download Excel</button>
    </div>
    <div class="card-body" id="filmshooting_datatable_container">
        <div class="table-responsive">
            <table id="filmshooting_datatable" class="table table-bordered table-hover">
                <thead>
                    ...
                    <tr>
                        ...
                        <th>
                            <?php if (is_admin() || is_view_all_district_user()) { ?>
                                <select id="district_for_filmshooting_list" class="form-control"
                        ...
                        <th>
                            <select id="entity_establishment_type_for_filmshooting_list" class="form-control"
                        ...
                        <th>
                            <input type="text" class="form-control" placeholder="Pro. Manager Name or Pro. House" />
                        </th>
                        <th>
                            <select id="app_timing_for_filmshooting_list" class="form-control">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="status_for_filmshooting_list" class="form-control"
                                    data-placeholder="Status !">
                                <option value="">All</option>
                            </select>
                        </th>
                        <th>
                            <select id="query_status_for_filmshooting_list" class="form-control"
