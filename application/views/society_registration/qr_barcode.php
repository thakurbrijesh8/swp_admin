<?php
$barcode_number = generate_barcode_number(VALUE_SIXTY, $society_registration_data['society_registration_id']);

$header_array = array();
$header_array['title'] = 'Certificate';
$header_array['department_name'] = 'Department of Collectorate';
$header_array['district'] = $society_registration_data['district'] == VALUE_THREE ? 'Dadra and Nagar Haveli' : 'Daman and Diu';
