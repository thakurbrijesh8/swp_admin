            ...
            <form role="form" id="inspection_form" name="inspection_form" onsubmit="return false;">
                  ...
                  <label>District <span class="color-nic-red">*</span></label>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="plinth_column" name="plinth_column" class="form-control" placeholder="Enter Survey no !" 
                                       maxlength="200"  value="{{inspection_data.plinth_column}}">
                            </div>
                     ...
                     <div class="row">                      
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_no" name="registration_no" class="form-control" placeholder="Enter Registration Number(Architect/Engineer/Structural Engineer) !"
                                       maxlength="100"  value="{{inspection_data.registration_no}}">
                            </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="signature_architecture_name_container_for_inspection" style="display: none;">
                            <label>9.1 Authorized Signatory<span style="color: red;">* <br></span></label><br><a id="seal_and_stamp_download" target="_blank">
                            <img id="signature_architecture_name_image_for_inspection" style="width: 250px; height: 250px; border: 2px solid blue;"></a>                           
                        </div>
                    </div>
                <!-- Architecture signature -->
                ...
                <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="sign_seal_name_container_for_inspection" style="display: none;">
                            ...
                            <img id="sign_seal_name_image_for_inspection" style="width: 250px; height: 250px; border: 2px solid blue;"></a>                            
                        </div>
                    </div>
                <!-- signature -->
...
<!-- Annexure-9 -->
              ...
              <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_inspection" class="btn btn-sm btn-success" onclick="Inspection.listview.submitInspection({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
