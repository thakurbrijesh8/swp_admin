                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="supplier_name" name="supplier_name" class="form-control" placeholder="Enter Name & Address of ERP System Supplier !" maxlength="100" onblur="checkValidation('incentive-partb', 'supplier_name', supplierNameAddressValidationMessage);">{{supplier_name}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="features" name="features" class="form-control" placeholder="Enter Features of the ERP System !" maxlength="100" onblur="checkValidation('incentive-partb', 'features', featureSystemValidationMessage);">{{features}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="iso_agency_name" name="iso_agency_name" class="form-control" placeholder="Enter Name & Address of Certifing Agency !" maxlength="100" onblur="checkValidation('incentive-partb', 'iso_agency_name', agencyNameValidationMessage);">{{iso_agency_name}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="iso_product_detail" name="iso_product_detail" class="form-control" placeholder="Enter Details of Product of which the certificate has been issued!" maxlength="100" onblur="checkValidation('incentive-partb', 'iso_product_detail', productDetailValidationMessage);">{{iso_product_detail}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="iso_certificate_no" name="iso_certificate_no" class="form-control" placeholder="Enter Certificate No. !" maxlength="100" onblur="checkValidation('incentive-partb', 'iso_certificate_no', isoCertificateNoValidationMessage);" value="{{iso_certificate_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="iso_certificate_date" id="iso_certificate_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{iso_certificate_date}}" onblur="checkValidation('incentive-partb', 'iso_certificate_date', isoCertificateDateValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="isi_agency_name" name="isi_agency_name" class="form-control" placeholder="Enter Name & Address of Certifing Agency !" maxlength="100" onblur="checkValidation('incentive-partb', 'isi_agency_name', agencyNameValidationMessage);">{{isi_agency_name}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="isi_product_detail" name="isi_product_detail" class="form-control" placeholder="Enter Details of Product of which the certificate has been issued!" maxlength="100" onblur="checkValidation('incentive-partb', 'isi_product_detail', productDetailValidationMessage);">{{isi_product_detail}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="isi_certificate_no" name="isi_certificate_no" class="form-control" placeholder="Enter Certificate No. !" maxlength="100" onblur="checkValidation('incentive-partb', 'isi_certificate_no', isicertificateNoValidationMessage);" value="{{isi_certificate_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="isi_certificate_date" id="isi_certificate_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{isi_certificate_date}}" onblur="checkValidation('incentive-partb', 'isi_certificate_date', isicertificateDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="expenditure" name="expenditure" class="form-control" placeholder="Enter Total Expenditure on Quality Certification !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-partb', 'expenditure', expenditureValidationMessage);" value="{{expenditure}}">
                            </div>
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="capital_cost" name="capital_cost" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliam($(this));checkValidation('incentive-partb', 'capital_cost', capitalCostValidationMessage);" value="{{capital_cost}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="consutancy_fees" name="consutancy_fees" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliam($(this));checkValidation('incentive-partb', 'consutancy_fees', consutancyFeesValidationMessage);" value="{{consutancy_fees}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="certification_charges" name="certification_charges" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliam($(this));checkValidation('incentive-partb', 'certification_charges', certificationChargesValidationMessage);" value="{{certification_charges}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="testing_equipments" name="testing_equipments" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliam($(this));checkValidation('incentive-partb', 'testing_equipments', testingEquipmentsValidationMessage);" value="{{testing_equipments}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>Total</th>
                                        <th>
                                            <input type="text" id="cliam_amount_total" name="cliam_amount_total" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('incentive-partb', 'cliam_amount_total', clamAmountTotalValidationMessage);" value="{{cliam_amount_total}}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partb_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.submitPartBDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
