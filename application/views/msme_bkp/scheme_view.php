                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="parta_form" name="parta_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(A) CAPITAL INVESTMENT / INTEREST SUBSIDY
                            <span class="error-message error-message-scheme-parta_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="partb_form" name="partb_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(B) ASSISTANCE FOR QUALITY CERTIFICATION
                            <span class="error-message error-message-scheme-partb_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="partc_form" name="partc_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(C) ASSISTANCE FOR PATENT REGISTRATION
                            <span class="error-message error-message-scheme-partc_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="partd_form" name="partd_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(D) ASSISTANCE FOR SAVING IN CONSUMPTION OF ENERGY AND WATER
                            <span class="error-message error-message-scheme-partd_form"></span>
                        </div>
                        <div class="form-group col-sm-12">
                            <input type="checkbox" disabled id="parte_form" name="parte_form" class="checkbox" value="{{VALUE_ONE}}">&nbsp;(E) INCENTIVES FOR LOCAL EMPLOYMENT
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_scheme_details" class="btn btn-sm btn-success pull-right"  onclick="MSME.listview.editOrViewFormsForView($('#previous_btn_for_scheme_details'), '{{incentive_id}}', false, 'scheme_form');" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
