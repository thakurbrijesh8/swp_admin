                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <span class="error-message error-message-incentive-parte f-w-b" style="border-bottom: 2px solid red;"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="newly_requit_emp" name="newly_requit_emp" class="form-control" placeholder="Enter Total Number of Local Employment Newly recruited !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parte', 'newly_requit_emp', requitEmpValidationMessage);" value="{{newly_requit_emp}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="emp_total_expenditure" name="emp_total_expenditure" class="form-control" placeholder="Enter Total Expenditure made on Local Employment !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parte', 'emp_total_expenditure', empExpenditureValidationMessage);" value="{{emp_total_expenditure}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="assclaim_amount" name="assclaim_amount" class="form-control" placeholder="Enter Total Amount Claim for Assistance !"
                                       maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parte', 'assclaim_amount', assclaimAmountValidationMessage);" value="{{assclaim_amount}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_parte_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.submitPartEDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
