<tr id="financial_institution_info_{{detail_cnt}}" class="financial_institution_info" style="background-color: #fff;">
    ...
    <td>
        <input type="text" id="sanction_amount_{{detail_cnt}}" name="sanction_amount_{{detail_cnt}}" class="form-control"
               maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'sanction_amount_{{detail_cnt}}', sanctionAmountValidationMessage);" value="{{sanction_amount}}">
    ...
    <td>
        <input type="text" id="rate_{{detail_cnt}}" name="rate_{{detail_cnt}}" class="form-control"
               maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'rate_{{detail_cnt}}', rateValidationMessage);" value="{{rate}}">
