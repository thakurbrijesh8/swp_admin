                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="consultant_name" name="consultant_name" class="form-control" placeholder="Enter Name and Address of auditing Institution / consultant for Energy / Water !" maxlength="100" onblur="checkValidation('incentive-partd', 'consultant_name', consultantNameAddressValidationMessage);">{{consultant_name}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="suggestion" name="suggestion" class="form-control" placeholder="Enter Brief of suggestions / recommendation of the Audit Study!" maxlength="100" onblur="checkValidation('incentive-partd', 'suggestion', suggestionValidationMessage);">{{suggestion}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="total_expenditure" name="total_expenditure" class="form-control" placeholder="Enter Total Expenditure made on Energy / water Conservation !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-partd', 'total_expenditure', totalExpenditureValidationMessage);" value="{{total_expenditure}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="box-footer" align="right" >
                                <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_equipments" onclick="MSME.listview.addEquipments({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add equipments Details
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="audit_fees" name="audit_fees" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliamAmount($(this));checkValidation('incentive-partd', 'audit_fees', auditFeesValidationMessage);" value="{{audit_fees}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="equipment_cost" name="equipment_cost" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalCliamAmount($(this));checkValidation('incentive-partd', 'equipment_cost', equipmentCostValidationMessage);" value="{{equipment_cost}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>Total</th>
                                        <th>
                                            <input type="text" id="cliam_amount_total" name="cliam_amount_total" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('incentive-partd', 'cliam_amount_total', clamAmountTotalValidationMessage);" value="{{cliam_amount_total}}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partd_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.submitPartDDetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
