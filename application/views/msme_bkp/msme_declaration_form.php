                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="sign_seal_container_for_msme">
                            <label>Upload Authorized Signatory Designation with Seal<span style="color: red;">* <br>(Maximum File Size: 1MB)&nbsp; (Upload JPG | PNG | JPEG | JFIF Only)</span></label><br>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_declaration_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.submitMsmeDeclaration({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
