                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="enterprise_name" name="enterprise_name" class="form-control" placeholder="Enter Name of the Enterprise !"
                                       maxlength="100" onblur="checkValidation('incentive-parta', 'enterprise_name', enterpriseNameValidationMessage);" value="{{enterprise_name}}">
                            </div>
                    ...
                    <div class="row new_project_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="investment" name="investment" class="form-control" placeholder="Enter Investment made in Plant & Machinery  - (In Lacs) !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'investment', investmentValidationMessage);" value="{{investment}}">
                            </div>
                    ...
                    <div class="row expansion_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="machinery_units" name="machinery_units" class="form-control" placeholder="Enter Investment already made in Plant & Machinery in Existing Unit !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'machinery_units', machineryUnitValidationMessage);" value="{{machinery_units}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="new_investment" name="new_investment" class="form-control" placeholder="Enter New Investment in Plant & Machinery !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'new_investment', newInvestmentValidationMessage);" value="{{new_investment}}">
                            </div>
                    ...
                    <div class="row expansion_div">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="investment_percentage" name="investment_percentage" class="form-control" placeholder="Enter Increase in Investment (%) !" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkValidation('incentive-parta', 'investment_percentage', investmentPercentageValidationMessage);" value="{{investment_percentage}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="box-footer" align="right" >
                                <button type="button" class="btn btn-sm btn-nic-blue float-right" id="submit_btn_for_financial_institution" onclick="MSME.listview.addFinancialInstitution({});" style="margin-right: 5px;margin-top: 5px;"><i class="fas fa-plus-circle" style="margin-right: 5px;"></i>Add Financial Institution Details
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="term_loan_date" id="term_loan_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{term_loan_date}}" onblur="checkValidation('incentive-parta', 'term_loan_date', termLoanDateValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="loan_accountno" name="loan_accountno" class="form-control" placeholder="Enter Term Loan Account No. !" maxlength="100" onblur="checkValidation('incentive-parta', 'loan_accountno', loanAccountNoValidationMessage);" value="{{loan_accountno}}">
                            </div>
                            ...
                            <table class="table table-bordered m-b-0px" id="productList" style="margin-top: 10px;">
                                <thead>
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="capital_subsidy" name="capital_subsidy" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalInvestment($(this));checkValidation('single-return', 'capital_subsidy', capitalSubsidyValidationMessage);" value="{{capital_subsidy}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>
                                            <input type="text" id="anum" name="anum" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));getTotalInvestment($(this));checkValidation('single-return', 'anum', anumValidationMessage);" value="{{anum}}">
                                    ...
                                    <tr style='color: #000;'>
                                        ...
                                        <th>Total</th>
                                        <th>
                                            <input type="text" id="cliam_amount_total" name="cliam_amount_total" class="form-control"placeholder="" maxlength="100" onkeyup="checkNumeric($(this));" onblur="checkNumeric($(this));checkValidation('single-return', 'cliam_amount_total', clamAmountTotalValidationMessage);" value="{{cliam_amount_total}}" readonly>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="commencement_date" id="commencement_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{commencement_date}}" onblur="checkValidation('incentive-parta', 'commencement_date', commencementDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="disbursement_date" id="disbursement_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{disbursement_date}}" onblur="checkValidation('incentive-parta', 'disbursement_date', disbursementDateValidationMessage);">
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="far fa-calendar"></i></span>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_parta_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.submitPartADetails({{VALUE_ONE}});" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
