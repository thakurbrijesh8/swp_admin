                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_no" name="registration_no" class="form-control" placeholder="Enter Patent Registration No. !"
                                       maxlength="100" readonly onblur="checkValidation('incentive-partc', 'registration_no', registrationNoValidationMessage);" value="{{registration_no}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="registration_date" id="registration_date" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{registration_date}}" readonly onblur="checkValidation('incentive-partc', 'registration_date', certificateDateValidationMessage);">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="patent_name" name="patent_name" class="form-control" placeholder="Enter Name & Address of Office from where patent registration was obtained !" maxlength="100" readonly onblur="checkValidation('incentive-partc', 'patent_name', patentNameValidationMessage);">{{patent_name}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="product_name" name="product_name" class="form-control" placeholder="Enter Name of Product / Activity for which Patent registration is obtained !" maxlength="100" readonly onblur="checkValidation('incentive-partc', 'product_name', productNameValidationMessage);">{{product_name}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="patent_expenditure" name="patent_expenditure" class="form-control" placeholder="Enter Total Expenditure made on patent registration with details !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partc', 'patent_expenditure', patentExpenditureValidationMessage);" value="{{patent_expenditure}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="claim_amount" name="claim_amount" class="form-control" placeholder="Enter Total Amount claim for Assistance (50% subsidy claim on Patent Registration) !" maxlength="100" onkeyup="checkNumeric($(this));" readonly onblur="checkValidation('incentive-partc', 'claim_amount', cliamAmountValidationMessage);" value="{{claim_amount}}">
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" id="submit_btn_for_partc_details" class="btn btn-sm btn-success pull-right" onclick="MSME.listview.editOrViewFormsForView($('#previous_btn_for_partc_details'), '{{incentive_id}}', false, 'partc_form');" style="margin-right: 5px;">Next <span class="fas fa-hand-point-right"></span></button>
