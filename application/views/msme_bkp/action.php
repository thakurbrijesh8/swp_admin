...
{{#if show_edit_btn}}
<button type="button" class="btn btn-sm btn-success" onclick="MSME.listview.editOrViewMSME($(this),'{{incentive_id}}',true);"
        style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i>Edit</button>
{{/if}}
<button type="button" class="btn btn-sm btn-primary" onclick="MSME.listview.editOrViewMSME($(this),'{{incentive_id}}',false);"
        style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    <i class="fas fa-eye" style="margin-right: 2px;"></i>View</button>
{{#if show_form_one_btn}}
    <button type="button" class="btn btn-sm btn-danger" 
            onclick="MSME.listview.generateForm1('{{incentive_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_wm_{{incentive_id}}" onclick="MSME.listview.getQueryData('{{incentive_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{incentive_id}}"
            onclick="MSME.listview.openUploadChallan('{{incentive_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{incentive_id}}"
            onclick="MSME.listview.viewPayment('{{incentive_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_msme_{{incentive_id}}"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_msme_{{incentive_id}}" onclick="MSME.listview.askForApproveApplication('{{incentive_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_msme_{{incentive_id}}"
            onclick="MSME.listview.askForRejectApplication('{{incentive_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-nic-blue"
            ...
            onclick="MSME.listview.generateCertificate('{{incentive_id}}');"
