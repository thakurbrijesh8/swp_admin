                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="digit_mobile_number" name="digit_mobile_number" class="form-control" placeholder="Mobile Number !"
                                       maxlength="100" onblur="checkValidationForMobileNumber('property', 'digit_mobile_number', mobileValidationMessage);" value="{{property_data.digit_mobile_number}}" onkeyup="checkNumeric($(this));">
                            </div>
                         ...
                         <label>8. Email Address  <span class="color-nic-red">*</span></label>
                            <div class="input-group">
                                <input type="text" id="email" name="email" class="form-control" placeholder="Email Address !"
                                       maxlength="100" onkeypress="emailIdValidation($(this));" onblur="checkValidationForEmail('property', 'email', emailValidationMessage);" value="{{property_data.email}}">
                            </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-6 m-b-5px" id="pan_card_container_for_property">
                            <label>9. Pan Card<span style="color: red;">*<br> (Maximum File Size: 1MB)(Upload jpg, png, jpeg ,jfif Only)</span></label><br>
                            <input type="file" id="pan_card_for_property" name="pan_card_for_property"
                        ...
                        <div class="form-group col-sm-6" id="pan_card_name_container_for_property" style="display: none;">
                            <label>9.1 Pan Card <span style="color: red;">*</span></label><br>
                 ...
                 <div class="row">
                        <div class="col-6 m-b-5px" id="aadhaar_card_container_for_property">
                            <label>10. Aadhaar Card<span style="color: red;">*<br> (Maximum File Size: 1MB)(Upload jpg, png, jpeg ,jfif Only)</span></label><br>
                            <input type="file" id="aadhaar_card_for_property" name="aadhaar_card_for_property"
                                   accept="image/jpg,image/png,image/jpeg">
