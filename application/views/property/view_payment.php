...
<div class="card-body p-b-0px text-left" style="font-size: 14px;">
    ...
    <div class="row">
        <div class="form-group col-sm-12">
            <label>Mobile Number <span class="color-nic-red">*</span></label>
            <input type="text" class="form-control" placeholder="Mobile Number"
                   value="{{digit_mobile_number}}" readonly="" />
        </div>
    </div>
    <div class="row">
        <div class="form-group col-sm-12">
    ...
    <div class="row" id="vp_container_for_property" style="display: none;">
        <div class="form-group col-sm-12">
            <label><span class="utitle_for_property">{{utitle}}</span> <span style="color: red;">*</label><br>
            <a id="fees_paid_challan_name_href_for_property" target="_blank">
                <i class="fas fa-cloud-download-alt" style="margin-right: 3px;"></i><span id="fees_paid_challan_name_for_property"></span>
            </a>
        </div>
    </div>
