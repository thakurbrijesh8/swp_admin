    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="boiler_act_renewal_form" name="boiler_act_renewal_form" onsubmit="return false;">
                <input type="hidden" id="boiler_renewal_id" name="boiler_renewal_id" value="{{boiler_renewal_id}}">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                 <select id="entity_establishment_type" name="entity_establishment_type" class="form-control select2"
                                    data-placeholder="Select Entity / Establishment Type" style="width: 100%;" onblur="checkValidation('boiler-act-renewal', 'entity_establishment_type', entityEstablishmentTypeValidationMessage);" disabled="">
                            </select>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Boiler License Number !"
                                       maxlength="100" value="{{license_number}}" onblur="BoilerActRenewal.listview.getBoilerActData($(this));checkValidation('boiler-act-renewal', 'registration_number', licenseNumberValidationMessage);" readonly>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="owner_name" name="owner_name" class="form-control" placeholder="Enter Name Of Owner !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'owner_name', ownerNameValidationMessage);" value="{{owner_name}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="situation_of_boiler" name="situation_of_boiler" class="form-control" placeholder="Enter Situation of Boiler !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'situation_of_boiler', boilerSituationValidationMessage);" value="{{situation_of_boiler}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="boiler_type" name="boiler_type" class="form-control" placeholder="Enter Boiler Type !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'boiler_type', boilerTypeValidationMessage);" value="{{boiler_type}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="ut" name="ut" class="form-control" placeholder="Enter U. T. !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'ut', utValidationMessage);" value="{{ut}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="working_pressure" name="working_pressure" class="form-control" placeholder="Enter Working Pressure Of Boiler !" onkeyup="checkNumeric($(this));"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'working_pressure', workingPressureValidationMessage);" value="{{working_pressure}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="max_pressure" name="max_pressure" class="form-control" placeholder="Enter Factory Building !" onkeyup="checkNumeric($(this));"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'max_pressure', maxPressureValidationMessage);" value="{{max_pressure}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="heating_surface_area" name="heating_surface_area" class="form-control" placeholder="Enter Heating Surface Area / Boiler Rating !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'heating_surface_area', heatingSurfaceValidationMessage);" onkeyup="checkNumeric($(this));" value="{{heating_surface_area}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="length_of_pipes" name="length_of_pipes" class="form-control" placeholder="Enter Total Length of steam Pipes !" onkeyup="checkNumeric($(this));"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'length_of_pipes', lengthPipesValidationMessage);" value="{{length_of_pipes}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="max_evaporation" name="max_evaporation" class="form-control" placeholder="Enter Maximum Continuous Evaporatio !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'max_evaporation', maxEvaporationValidationMessage);" value="{{max_evaporation}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="place_of_manufacture" name="place_of_manufacture" class="form-control" placeholder="Enter Place Of Manufacture !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'place_of_manufacture', manufacturePlaceValidationMessage);" value="{{place_of_manufacture}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="year_of_manufacture" name="year_of_manufacture" class="form-control" placeholder="Enter Year Of Manufacture !" onkeyup="checkNumeric($(this));"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'year_of_manufacture', manufactureYearValidationMessage);" value="{{year_of_manufacture}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_manufacture" name="name_of_manufacture" class="form-control" placeholder="Enter Name Of Manufacture !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'name_of_manufacture', manufactureNameValidationMessage);" value="{{name_of_manufacture}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="manufacture_address" name="manufacture_address" class="form-control" placeholder="Enter Manufacture Address !" maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'manufacture_address', manufactureAddressValidationMessage);">{{manufacture_address}}</textarea>
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date">
                                <input type="text" name="hydraulically_tested_on" id="hydraulically_tested_on" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{hydraulically_tested_on_text}}" readonly onblur="checkValidation('bocw', 'hydraulically_tested_on', hydrulicallyTestedOnValidationMessage);">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="hydraulically_tested_to" name="hydraulically_tested_to" class="form-control" placeholder="Enter Hydraulically Tested To !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'hydraulically_tested_to', hydrulicallyTestedValidationMessage);" value="{{hydraulically_tested_to}}">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="repairs" name="repairs" class="form-control" placeholder="Enter Repairs !"
                                       maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'repairs', repairsValidationMessage);" value="{{repairs}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <textarea id="remarks" name="remarks" class="form-control" placeholder="Enter Remarks !" maxlength="100" readonly onblur="checkValidation('boiler-act-renewal', 'remarks', remarksValidationMessage);">{{remarks}}</textarea>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6" id="company_letter_head_container_for_boiler">
                            <label>20.  Application on Company Letter head</label><br>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6" id="copy_of_challan_container_for_boiler">
                            <label>21.  Fees as per the schedule</label><br>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6" id="last_boiler_license_container_for_boiler">
                            <label>22.  A copy of last Boiler License</label><br>
