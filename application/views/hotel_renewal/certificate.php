<?php
$barcode_number = generate_barcode_number(VALUE_TWENTY, $hotel_renewal_data['hotel_renewal_id']);
...
<div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;text-decoration: underline;">HOTEL REGISTRATION RENEWAL CERTIFICATE</div>
...
<table class="CompanyDetails">
    <tr>
        ...
        <td class="third-column">
            <?php echo $hotel_renewal_data['registration_number']; ?>
        </td>
    </tr>
    <tr>
        <td class="second-column">Name of the Hotel :</td>
        <td class="third-column">
            <?php echo $hotel_renewal_data['name_of_hotel']; ?><br>
        </td>
    </tr>
    <tr>
        <td class="second-column">Name of the proprietor : </td>
        <td class="third-column">
            <?php echo $hotel_renewal_data['name_of_proprietor']; ?>
        </td>
    </tr>
    <tr>
        <td class="second-column">The Registration is hereby renewed upto :</td>
        <td class="third-column">
            <span style="border-bottom: 1px solid black;"><?php echo convert_to_new_date_format($hotel_renewal_data['valid_upto']); ?></span>
        </td>
    </tr>
    <tr>
        <td class="second-column">Reg. Fees of Rs. :</td>
        <td class="third-column">
            <span style="border-bottom: 1px solid black;"><?php echo $hotel_renewal_data['fees']; ?></span>
        </td>
    </tr>
    <tr>
        <td class="second-column">Paid vide chalan No. :</td>
        <td class="third-column">
            <span style="border-bottom: 1px solid black;"><?php echo $hotel_renewal_data['challan_number']; ?></span>
        </td>
    </tr>
</table>
<br />
...
<!--<div style="font-size: 14px; text-align: right; margin-bottom: 5px;margin-right: 40px;"><img src="<?php echo HOTELREGI_DOC_PATH; ?><?php echo $hotel_renewal_data['signature']; ?>" height="80px" width="80px"></div>-->
