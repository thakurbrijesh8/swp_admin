    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <form role="form" id="hotel_renewal_form" name="hotel_renewal_form" onsubmit="return false;">
                ...
                <input type="hidden" id="hotel_renewal_id" name="hotel_renewal_id" value="{{hotel_renewal_id}}">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="registration_number" name="registration_number" class="form-control" placeholder="Enter Dealer's License Number !"
                                       maxlength="100" value="{{registration_number}}" disabled="">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_hotel" name="name_of_hotel" class="form-control" placeholder="Name of Hotel !"
                                       maxlength="100" disabled="" value="{{name_of_hotel}}">
                            </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="name_of_proprietor" name="name_of_proprietor" class="form-control" placeholder="Name of the Proprietor !" maxlength="100" value="{{name_of_proprietor}}" disabled="">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group date ">
                                <input type="text" name="last_valid_upto" id="last_valid_upto" class="form-control date_picker" placeholder="dd-mm-yyyy" data-date-format="DD-MM-YYYY"
                                       value="{{last_valid_upto}}" disabled="">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <input type="text" id="fees" name="fees" class="form-control" placeholder="Fees !"disabled=""
                                       maxlength="100" value="{{fees}}">
                            </div>
                            <span class="error-message error-message-hotelrenewal-name_of_hotel"></span>
                        </div>
                    </div>
