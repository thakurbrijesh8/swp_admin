<html>
    ...
    <body>
        ...
        <div style="font-size: 16px; text-align: center; margin-top: 0px;font-weight: bold;margin-bottom: 20px;">Hotel Registration Renewal Form</div>
        <div class="row">
        </div>
        <br/>
        <table class="CompanyDetails">
            ...
            <tr>
                ...
                <td class="second-column">License last renewed upto -</td>
                <td class="third-column">
                    <?php echo convert_to_new_date_format($hotel_renewal_data['last_valid_upto']); ?>
                </td>
            </tr>
            <tr>
                <td class="first-column">5.</td>
                <td class="second-column">Details of the new employees, if any  -</td>
                <td class="third-column">
                    <?php
                        $newemployeesinfo = json_decode($hotel_renewal_data['new_employees_details'], TRUE);
                        $i = 1;
                        foreach ($newemployeesinfo as $value) {
        ...
        <br />
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo HOTELREGI_DOC_PATH; ?><?php echo $hotel_renewal_data['signature']; ?>" height="80px" width="80px"></div>
