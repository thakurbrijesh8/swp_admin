<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" id="edit_btn_{{hotel_renewal_id}}" onclick="HotelRenewal.listview.editOrViewHotelRenewal($(this),'{{hotel_renewal_id}}', true);"
    ...
    <button type="button" class="btn btn-sm btn-secondary" id="withdraw_application_btn_{{hotel_renewal_id}}"
            onclick="askForWithdrawApplication($(this), VALUE_TWENTY,'{{hotel_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_TWENTY,'{{hotel_renewal_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
