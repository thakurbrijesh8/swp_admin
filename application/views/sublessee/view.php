      ...
      <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="request_letter_manufacture_name_container_for_sublessee" style="display: none;">
                            ...
                            <a target="_blank" id="request_letter_manufacture_download"><label id="request_letter_manufacture_name_image_for_sublessee" style="border: 2px solid black;" class="btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="detail_project_report_name_container_for_sublessee" style="display: none;">
                            ...
                            <a target="_blank" id="detail_project_report_download"><label id="detail_project_report_name_image_for_sublessee" style="border: 2px solid black;" class="btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12" id="memorandum_partnership_deed_name_container_for_sublessee" style="display: none;">
                            ...
                            <a target="_blank" id="memorandum_partnership_deed_download"><label id="memorandum_partnership_deed_name_image_for_sublessee" style="border: 2px solid black;" class="btn-nic-blue f-w-n">{{VIEW_UPLODED_DOCUMENT}}</label></a>
                        </div>
                    </div>
                   <div class="row">
                        <div class="form-group col-sm-12">
                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-sm btn-danger" onclick="Sublessee.listview.loadSublesseeData();">Close</button>
                    </div>
                </div>
            </form>
        </div>
