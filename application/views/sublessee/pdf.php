<html>
    ...
    <body>
        ...
        <div style="font-size: 14px; text-align: left; margin-bottom: 12px;margin-left:  290px;">Date :-&nbsp;<div style="margin-left:  50px;margin-top: -20px;border-bottom: 1px solid black;width: 350px; ">&emsp;<?php echo convert_to_new_date_format($sublessee_data['created_time']); ?></div></div>
        <div class="row">
        ...
        <div style="font-size: 14px; text-align: center; margin-top: 10px;text-decoration: underline;">Subject : Permission for sub-lessee of premises on Plot No……, Survey No……… admeasuring ……… square metre, Government Industrial Estate, ….………. In favour of M/s…………………….</div>
        <br/>
        <table class="CompanyDetails">
            <tr>
                <td class="first-column">1.</td>
                <td class="second-column">Name of Sub-lessee Applicant</td>
                <td class="third-column">
                    <?php echo $sublessee_data['name_of_applicant']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['district']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['taluka']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['village']; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['plot_no']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['survey_no']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['admeasuring']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['estate_area']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $sublessee_data['name_of_manufacturing']; ?>
                </td>
            </tr>
        ...
        <div style="font-size: 14px; text-align: right; margin-bottom: 5px;"><img src="<?php echo base_url(); ?>documents/sublessee/<?php echo $sublessee_data['signature']; ?>" height="80px" width="80px"></div>
