<div class="text-center">
    ...
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="BoilerManufacture.listview.editOrViewBoilerManufacture($(this),'{{boilermanufacture_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-warning" id="query_btn_for_app_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.getQueryData('{{boilermanufacture_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-question" style="margin-right: 5px;"></i> Raise / View Query</button>
    {{/if}}
    {{#if show_upload_challan_btn}}
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.openUploadChallan('{{boilermanufacture_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.viewPayment('{{boilermanufacture_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{boilermanufacture_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{boilermanufacture_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.askForApproveApplication('{{boilermanufacture_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_boiler_manufacture_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.askForRejectApplication('{{boilermanufacture_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-nic-blue"
            id="download_certificate_btn_for_app_{{boilermanufacture_id}}"
            onclick="BoilerManufacture.listview.generateCertificate('{{boilermanufacture_id}}');"
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_THIRTYEIGHT,'{{boilermanufacture_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
