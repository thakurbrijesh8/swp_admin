            ...
            <form role="form" id="boiler_manufacture_form" name="boiler_manufacture_form" onsubmit="return false;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="copy_of_noc_container_for_manufacturer">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6" id="plan_of_workshop_container_for_manufacturer">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 m-b-5px" id="signature_and_seal_container_for_manufacturer">
                            ...
                            <input type="file" id="signature_and_seal_for_manufacturer" name="signature_and_seal_for_manufacturer"
                                   accept="image/jpg,image/png,image/jpeg,image/jfif">
                            <div class="error-message error-message-boiler-manufacture-signature_and_seal_for_manufacturer"></div>
                        </div>
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_manufacturer" class="btn btn-sm btn-success" onclick="BoilerManufacture.listview.submitBoilerManufacture({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
