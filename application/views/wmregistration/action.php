<div class="text-center">
    {{#if show_edit_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="Wmregistration.listview.editOrViewWmregistration($(this),'{{wmregistration_id}}', true);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-pencil-alt" style="margin-right: 2px;"></i> Edit</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-primary" onclick="Wmregistration.listview.editOrViewWmregistration($(this),'{{wmregistration_id}}', false);"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
    ...
    <button type="button" class="btn btn-sm btn-info" id="upload_challan_btn_{{wmregistration_id}}"
            onclick="Wmregistration.listview.openUploadChallan('{{wmregistration_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="download_fees_paid_challan_btn_{{wmregistration_id}}"
            onclick="Wmregistration.listview.viewPayment('{{wmregistration_id}}');"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
        <i class="fas fa-info-circle" style="margin-right: 2px;"></i> View Payment</button>
    {{/if}}
    <button type="button" class="btn btn-sm btn-warning" id="confirm_payment_btn_for_app_{{wmregistration_id}}"
            onclick="askForConfirmPayment('{{module_type}}', '{{wmregistration_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-success" id="approve_btn_for_app_{{wmregistration_id}}" onclick="Wmregistration.listview.askForApproveApplication('{{wmregistration_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-danger" id="reject_btn_for_app_{{wmregistration_id}}"
            onclick="Wmregistration.listview.askForRejectApplication('{{wmregistration_id}}');"
    ...
    <button type="button" class="btn btn-sm btn-nic-blue" id="download_certificate_btn_for_app_{{wmregistration_id}}"
            onclick="Wmregistration.listview.generateCertificate('{{wmregistration_id}}');"
    ...
    {{#if show_fr_btn}}
    <button type="button" class="btn btn-sm btn-success" onclick="showFeedbackRating($(this), VALUE_ONE,'{{wmregistration_id}}')"
            style="padding: 2px 7px; margin-top: 1px; margin-bottom: 2px;">
