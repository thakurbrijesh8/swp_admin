<html>
    ...
    <body>
        ...
        <table class="CompanyDetails">
            <tr>
                ...
                <td class="third-column">
                    <?php echo $wmregistration_data['name_of_applicant']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $wmregistration_data['location_of_factory']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $wmregistration_data['branches']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php echo $wmregistration_data['application_category']; ?>
                </td>
            </tr>
            <tr>
                ...
                <td class="third-column">
                    <?php 
                        if($wmregistration_data['proprietor_details']){ ?>
                        <table class="newTable" border="1">
                            ...
                            <?php
                                $proprietorinfo = json_decode($wmregistration_data['proprietor_details'], TRUE);
                                $i=1;
        ...
        <table style="margin-left: 475px;">
            <tr><td class="border-none"><img src="<?php echo WMREG_DOC_PATH; ?><?php echo $wmregistration_data['signature']; ?>" height="100px" width="100px"></td></tr>
        </table>
