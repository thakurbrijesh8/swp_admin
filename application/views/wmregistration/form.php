                ...
                <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                <select class="form-control" id="application_category" name="application_category"
                                    data-placeholder="Status !" onblur="checkValidation('manufacturer', 'application_category', applicantCategoryValidationMessage);">
                            ...
                            <span class="error-message error-message-manufacturer-application_category"></span>
                        </div>
                        <div class="form-group col-sm-6">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_wmregistration" class="btn btn-sm btn-success" onclick="Wmregistration.listview.submitWmregistration({{VALUE_TWO}});" style="margin-right: 5px;">Submit</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="showTableContainer('wmregistration');">Close</button>
                    </div>
                </div>
            </form>
        </div>
