                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                        <button type="button" id="submit_btn_for_wmregistration" class="btn btn-sm btn-success" onclick="Wmregistration.listview.submitWmregistration({{VALUE_TWO}});" style="margin-right: 5px;"><i class="fas fa-save"></i> Submit</button>
