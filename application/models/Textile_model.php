...
class Textile_model extends CI_Model {
    ...
    function get_all_textile_list($start, $length, $search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        ...
        if ($search_app_timing != '') {
            ...
            $qm_data = isset($query_module_array[VALUE_TEN]) ? $query_module_array[VALUE_TEN] : array();
    ...
    function get_total_count_of_records($search_district) {
        $this->db->select('COUNT(textile_id) AS total_records');
    ...
    function get_filter_count_of_records($search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        $this->db->select('COUNT(r.textile_id) AS total_records');
        if ($search_district != '') {
            $this->db->where('r.district', $search_district);
        }
        if ($search_entity_establishment_type != '') {
    ...
    function get_records_for_excel($search_district) {
        $this->db->select('r.textile_id, r.district, r.entity_establishment_type, u.applicant_name, u.mobile_number, r.enterprise_name, '
