...
class Msme_model extends CI_Model {
    ...
    function get_all_msme_list($start, $length, $search_district='', $search_applicant_name = '',  $search_applicant_mobile = '', $search_enterprise='' , $search_status = '') {
        ...
        $this->db->from('incentive_generalform AS r');
    ...
    function get_msme_by_id($incentive_id) {
        $this->db->where('is_delete !=', IS_DELETE);
        $this->db->where('incentive_id', $incentive_id);
        $this->db->from('incentive_generalform');
        $resc = $this->db->get(); 
