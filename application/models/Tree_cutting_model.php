...
class Tree_cutting_model extends CI_Model {
    ...
    function get_all_tree_cutting_list($start, $length, $search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
    ...
    function get_total_count_of_records($search_district) {
        $this->db->select('COUNT(tree_cutting_id) AS total_records');
    ...
    function get_filter_count_of_records($search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        $this->db->select('COUNT(r.tree_cutting_id) AS total_records');
        if ($search_district != '') {
            $this->db->where('r.district', $search_district);
        }
        if ($search_entity_establishment_type != '') {
    ...
    function get_records_for_excel($search_district) {
        $this->db->select('r.tree_cutting_id, r.district, r.village_dmc_ward, r.entity_establishment_type, '
                . 'u.applicant_name AS u_app_name, u.mobile_number, r.applicant_name, r.applicant_address, '
                . 'r.applicant_mobile_number, r.owner_name, r.owner_address, '
...
/*
 * EOF: ./application/models/Tree_cutting_model.php
 */