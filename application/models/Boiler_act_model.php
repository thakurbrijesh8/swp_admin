...
class Boiler_act_model extends CI_Model {
    ...
    function get_all_boiler_act_list($start, $length, $search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        ...
        if ($search_app_timing != '') {
            ...
            $qm_data = isset($query_module_array[VALUE_THIRTYSEVEN]) ? $query_module_array[VALUE_THIRTYSEVEN] : array();
    ...
    function get_total_count_of_records($search_district) {
        $this->db->select('COUNT(boiler_id) AS total_records');
    ...
    function get_filter_count_of_records($search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        $this->db->select('COUNT(b.boiler_id) AS total_records');
        if ($search_district != '') {
            $this->db->where('b.district', $search_district);
        }
        if ($search_entity_establishment_type != '') {
    ...
    function get_records_for_excel($search_district) {
        $this->db->select('b.boiler_id, b.district, b.entity_establishment_type, u.applicant_name, u.mobile_number, b.owner_name, '
