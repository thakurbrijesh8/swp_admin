...
class Nil_certificate_model extends CI_Model {

    function get_all_nil_certificate_list($start, $length, $search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
    ...
    function get_total_count_of_records($search_district) {
        $this->db->select('COUNT(nil_certificate_id) AS total_records');
    ...
    function get_filter_count_of_records($search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        $this->db->select('COUNT(r.nil_certificate_id) AS total_records');
        if ($search_district != '') {
            $this->db->where('r.district', $search_district);
        }
        if ($search_entity_establishment_type != '') {
    ...
    function get_records_for_excel($search_district) {
        $this->db->select('r.nil_certificate_id, r.district, r.village_dmc_ward, r.entity_establishment_type, '
                . 'u.applicant_name AS u_app_name, u.mobile_number, r.applicant_name, r.applicant_address, '
                . 'r.applicant_mobile_number, r.purpose, r.property_detail, '
...
/*
 * EOF: ./application/models/Nil_certificate_model.php
 */