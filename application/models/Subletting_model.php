...
class Subletting_model extends CI_Model {
    ...
    function get_all_subletting_list($start, $length, $search_district = '', $search_entity_establishment_type = '', $search_logged_user_detail = '', $search_applicant_detail = '', $search_plot_no = '', $search_nom = '', $search_app_timing = '', $search_status = '', $search_query_status = '') {
        ...
        if ($search_app_timing != '') {
            ...
            $qm_data = isset($query_module_array[VALUE_THIRTEEN]) ? $query_module_array[VALUE_THIRTEEN] : array();
    ...
    function get_records_for_excel($search_district) {
        $this->db->select('s.subletting_id, s.district, s.entity_establishment_type, u.applicant_name, u.mobile_number, s.name_of_applicant, '
...
/*
 * EOF: ./application/models/Subletting_model.php
 */