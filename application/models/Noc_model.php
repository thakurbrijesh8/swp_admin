...
class Noc_model extends CI_Model {
    ...
    function get_all_noc_list($start, $length, $session_district, $search_applicant_name = '', $search_status = '', $search_query_status = '') {
    ...
    function get_filter_count_of_records($session_district,$search_applicant_name = '', $search_status = '', $search_query_status = '') {
