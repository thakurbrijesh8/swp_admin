...
Hotelregi.listView = Backbone.View.extend({
    ...
    actionRenderer: function (rowData) {
        ...
        if ((tempTypeInSession == TEMP_TYPE_A || tempTypeInSession == TEMP_TYPE_TOURISM) && rowData.status != VALUE_FIVE && rowData.status != VALUE_SIX && rowData.status != VALUE_ELEVEN) {
    ...
    openUploadChallan: function (hotelregiId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                showPopup();
                if (hotelregiData.status != VALUE_FOUR && hotelregiData.status != VALUE_FIVE && hotelregiData.status != VALUE_SIX && hotelregiData.status != VALUE_SEVEN && hotelregiData.status != VALUE_EIGHT && hotelregiData.status != VALUE_ELEVEN) {
