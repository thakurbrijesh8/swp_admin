...
Construction.listView = Backbone.View.extend({
    ...
    loadConstructionData: function (sDistrict, sStatus, sAppTimingStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            return getAppNoWithRating(VALUE_TWENTYSIX, data, full.district, full);
        };
    ...
    openUploadChallan: function (constructionId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                showPopup();
                if (constructionData.status != VALUE_FOUR && constructionData.status != VALUE_FIVE && constructionData.status != VALUE_SIX && constructionData.status != VALUE_SEVEN && constructionData.status != VALUE_EIGHT && constructionData.status != VALUE_ELEVEN) {
