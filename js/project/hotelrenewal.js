    ...
    loadHotelRenewalData: function (sDistrict, sStatus, sAppTimingStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            if (tempTypeInSession == TEMP_TYPE_A || tempTypeInSession == TEMP_TYPE_VDD)
                return regNoRenderer(VALUE_TWENTY, data) + '<hr>' + (talukaArray[full.name_of_tourist_area] ? talukaArray[full.name_of_tourist_area] : '');
            else
    ...
    openUploadChallan: function (hotelRenewalId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                showPopup();
                if (hotelRenewalData.status != VALUE_FOUR && hotelRenewalData.status != VALUE_FIVE && hotelRenewalData.status != VALUE_SIX && hotelRenewalData.status != VALUE_SEVEN && hotelRenewalData.status != VALUE_EIGHT) {
