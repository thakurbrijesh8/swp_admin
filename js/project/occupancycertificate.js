    ...
    loadOccupancyCertificateData: function (sDistrict, sStatus, sAppTimingStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            if (tempTypeInSession == TEMP_TYPE_A || tempTypeInSession == TEMP_TYPE_VDD)
                return regNoRenderer(VALUE_TWENTYEIGHT, data) + '<hr>' + (talukaArray[full.district] ? talukaArray[full.district] : '');
            else
    ...
    openUploadChallan: function (occupancyCertificateId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                showPopup();
                if (occupancyCertificateData.status != VALUE_FOUR && occupancyCertificateData.status != VALUE_FIVE && occupancyCertificateData.status != VALUE_SIX && occupancyCertificateData.status != VALUE_SEVEN && occupancyCertificateData.status != VALUE_EIGHT) {
