    ...
    openUploadChallan: function (propertyId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                showPopup();
                if (propertyData.status != VALUE_FOUR && propertyData.status != VALUE_FIVE && propertyData.status != VALUE_SIX && propertyData.status != VALUE_SEVEN && propertyData.status != VALUE_EIGHT && propertyData.status != VALUE_ELEVEN) {
