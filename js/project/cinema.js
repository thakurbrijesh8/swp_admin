...
Cinema.listView = Backbone.View.extend({
    ...
    loadCinemaData: function (sDistrict, sStatus, sAppTimingStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            return getAppNoWithRating(VALUE_EIGHT, data, full.district, full);
        };
    ...
    viewCinemaForm: function (parseData) {
        ...
        formData.CINEMA_DOC_PATH = CINEMA_DOC_PATH;  
       ...
       formData.application_number = regNoRenderer(VALUE_EIGHT, formData.cinema_id);
       ...
       formData.show_signature = formData.signature != '' ? true : false;          
