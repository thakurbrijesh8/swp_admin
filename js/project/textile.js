...
Textile.listView = Backbone.View.extend({
    ...
    loadTextileData: function (sDistrict, sStatus, sAppTimingStatus) {
        ...
        var tempRegNoRenderer = function (data, type, full, meta) {
            return getAppNoWithRating(VALUE_TEN, data, full.district, full);
        };
    ...
    openUploadChallan: function (incentiveId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var textileData = parseData.textile_data;
                showPopup();
                if (textileData.status != textileData && textileData.status != VALUE_FIVE && textileData.status != VALUE_SIX && textileData.status != VALUE_SEVEN && textileData.status != VALUE_EIGHT && textileData.status != VALUE_ELEVEN) {
